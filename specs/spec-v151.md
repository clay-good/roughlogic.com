...
> **Status: CUT as a duplicate (2026-07-01, the 0.89.0 dupe vet: the live moisture-dry-goal tile already returns the delta above the dry standard; will not be built; was PROPOSED 2026-06-23, DEFERRED 2026-06-29: held back as conceptually adjacent to live water and mold tiles when the fire and smoke subset v141/v146-v148/v152-v154 landed at 0.85.0). Batch spec-v151..v156.** In-scope catalog expansion under the
