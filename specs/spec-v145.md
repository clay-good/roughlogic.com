...
> **Status: CUT as a duplicate (2026-07-01, the 0.89.0 dupe vet: the live antimicrobial-dilution tile already sizes gallons from area and label coverage; will not be built; was PROPOSED 2026-06-23, DEFERRED 2026-06-29: held back as conceptually adjacent to live water and mold tiles when the fire and smoke subset v141/v146-v148/v152-v154 landed at 0.85.0). Batch spec-v141..v145.** In-scope catalog expansion under the
