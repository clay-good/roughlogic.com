...
> **Status: CUT 2026-08-27 (proposed 2026-08-26): a duplicate of `stairwell-pressurization`, which already computes it (see [scope-trade-expansion](scope-trade-expansion.md)); not built. Single-tile spec.** Part of [scope-trade-expansion](scope-trade-expansion.md).
