...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-agriculture.js", "AGRICULTURE_RENDERERS", [
    ...
    // v17
    "irrigation-requirement", "mad-irrigation-trigger", "cattle-stocking-rate", "grain-bin-capacity", "grain-bin-height-for-capacity", "bunker-silo-capacity", "feed-conversion-ratio",
  ...
  declare("./calc-water.js", "WATER_RENDERERS", [
    ...
    "chlorine-demand", "dechlorination-dose", "float-method-flow", "uv-dose", "uv-required-exposure",
    // spec-v570
