...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-construction.js", "CONSTRUCTION_RENDERERS", [
    ...
    // v3
    "corner-bead-takeoff", "drywall", "roofing-squares", "asphalt-tonnage", "asphalt-paving-speed", "asphalt-tack-coat-quantity", "aggregate", "stockpile-volume", "mortar-mix",
    ...
    "shore-post-load", "scaffold-mudsill-bearing", "scaffold-leg-load", "scaffold-takeoff", "asphalt-spread-rate", "pavement-milling-production", "striping-paint-quantity", "concrete-vibrator-spacing", "formwork-tie-load", "mass-concrete-temp-rise", "concrete-washout-volume", "shingle-nails", "duct-metal-weight", "duct-bank-concrete", "duct-wrap-takeoff", "duct-hanger-load", "roof-underlayment-rolls", "membrane-roof-takeoff", "roof-ballast-weight", "tapered-roof-insulation", "sheathing-takeoff", "construction-adhesive-tubes", "sill-plate-anchor-count", "metal-stud-takeoff", "suspended-ceiling-grid", "masonry-control-joint-layout", "dumpster-count", "sealant-joint-yield", "self-leveler-bags", "carpet-takeoff", "sfrm-takeoff", "spray-foam-board-feet", "metal-deck-takeoff", "rebar-tie-wire", "anchor-epoxy-volume", "baseplate-grout-volume", "baluster-picket-count", "traffic-taper-length", "siding-takeoff", "siding-course-layout", "stucco-coverage", "vapor-barrier-rolls", "concrete-sawcut-footage", "foundation-waterproofing-takeoff", "drainage-board-takeoff", "joist-hanger-count", "drywall-fastener-takeoff", "glass-vacuum-lift", "polymeric-sand-bags", "rigid-foam-board-count", "roof-insulation-fasteners", "housewrap-rolls", "chain-link-fence-takeoff", "curb-gutter-volume", "rebar-chair-count", "concrete-evaporation-rate", "concrete-strength-gain",
  ...
  declare("./calc-finish.js", "FINISH_RENDERERS", [
    ...
    "attic-ventilation", "soffit-ridge-vent-count", "gutter-downspout", "gutter-downspout-takeoff", "deck-board-takeoff", "rough-opening-size", "closet-shelf-takeoff", "countertop-overhang-support", "glass-weight",
  ...
  declare("./calc-masonry.js", "MASONRY_RENDERERS", [
    ...
    "masonry-wall-weight", "brick-veneer-anchor-spacing", "brick-veneer-weep-count", "masonry-joint-reinforcement", "masonry-lintel-loading", "masonry-lintel-bearing",
  ...
  declare("./calc-earthwork.js", "EARTHWORK_RENDERERS", [
    ...
    "water-for-compaction", "soil-phase-relations", "atterberg-indices", "fineness-modulus", "soil-gradation-coefficients",
  ]);
  ...
  declare("./calc-cross.js", "CROSS_RENDERERS", [
    ...
    "trench-slope", "niosh-lifting", "heat-stress", "wind-chill", "wind-chill-wind-speed", "ladder-angle", "extension-ladder-overlap",
  ...
  declare("./calc-mechanic.js", "MECHANIC_RENDERERS", [
    ...
    "hydraulic-pump-horsepower", "hydraulic-drive-flow-limit", "hydraulic-motor-torque-speed", "hydraulic-pump-flow", "hydraulic-line-velocity", "cooling-system-flow",
