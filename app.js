...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-mechanic.js", "MECHANIC_RENDERERS", [
    ...
    "spring-wire-stress",
    "gear-tooth-bending-stress", "gear-dynamic-tooth-stress", "gear-contact-stress", "aerodynamic-drag-force", "vehicle-road-load-power", "planetary-gear-ratio", "band-brake-torque", "centrifugal-force", "torsion-spring-rate", "universal-joint-speed",
