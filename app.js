...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-shop.js", "SHOP_RENDERERS", [
    ...
    "tolerance-stack-rss", "cone-flat-pattern", "frustum-volume", "regular-polygon", "ellipse-area-perimeter", "spherical-cap-volume", "parabolic-segment", "pyramid-frustum-volume", "torus-volume", "ellipsoid-volume", "annulus-area", "circular-sector", "tank-volume-dished-heads", "spherical-zone-volume", "oval-tank-volume",
  ...
  declare("./calc-mechanic.js", "MECHANIC_RENDERERS", [
    ...
    "spring-wire-stress",
    "gear-tooth-bending-stress", "gear-dynamic-tooth-stress", "gear-contact-stress", "aerodynamic-drag-force", "vehicle-road-load-power", "planetary-gear-ratio", "band-brake-torque", "centrifugal-force", "torsion-spring-rate", "universal-joint-speed", "slider-crank-piston-position", "impact-load-factor", "hydraulic-accumulator-volume", "projectile-range", "free-fall-drop", "terminal-velocity",
