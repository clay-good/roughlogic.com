...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-construction.js", "CONSTRUCTION_RENDERERS", [
    ...
    // v3
    "corner-bead-takeoff", "drywall", "roofing-squares", "asphalt-tonnage", "asphalt-paving-speed", "asphalt-tack-coat-quantity", "chip-seal-mcleod", "aggregate", "stockpile-volume", "windrow-stockpile-volume", "mortar-mix",
