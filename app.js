...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-drainage.js", "DRAINAGE_RENDERERS", [
    ...
    "manning-slope", "manning-pipe-capacity", "pipe-partial-flow-depth", "tr55-time-of-concentration", "composite-curve-number", "curve-number-runoff", "tr55-graphical-peak-discharge", "tr55-detention-storage",
  ]);
  ...
  declare("./calc-concrete.js", "CONCRETE_RENDERERS", [
    ...
    "concrete-effective-inertia", "concrete-longterm-defl",
    // spec-v548
  ...
  declare("./calc-machining.js", "MACHINING_RENDERERS", [
    // v31, v34
    "cutting-speed-rpm", "thread-single-depth", "acme-thread-depth", "cutting-diameter-for-rpm", "drill-point-depth", "drill-point-angle-from-length",
  ...
  declare("./calc-treatment.js", "TREATMENT_RENDERERS", [
    "weir-flow", "cipolletti-weir", "weir-head-from-flow", "langelier-index", "chemical-feed-pump",
  ...
  declare("./calc-edu.js", "EDU_RENDERERS", [
    ...
    // v20
    "final-grade-needed", "category-weighted-grade", "two-sample-t-test", "paired-t-test", "one-sample-t-test",
  ]);
