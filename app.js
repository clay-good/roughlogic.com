...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-electrical.js", "ELECTRICAL_RENDERERS", [
    ...
    // v3
    "pulling-tension", "cable-reel-capacity", "wire-pulling-lubricant", "branch-circuit-wire-footage", "microinverter-branch-count", "cable-bend-radius", "pf-correction", "phase-balance",
  ...
  declare("./calc-lowvoltage.js", "LOWVOLTAGE_RENDERERS", [
    ...
    "camera-lens-fov", "camera-max-distance-for-ppf", "ceiling-speaker-coverage", "ceiling-speaker-coverage-angle", "structured-cabling-channel", "lv-cable-pull-footage", "cable-support-jhook", "access-control-power-supply",
  ]);
  ...
  declare("./calc-firesprinkler.js", "FIRESPRINKLER_RENDERERS", [
    "fire-pump-curve", "sprinkler-system-demand", "sprinkler-protection-area-for-supply", "sprinkler-head-layout", "smoke-detector-spacing-count",
