...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-earthwork.js", "EARTHWORK_RENDERERS", [
    ...
    "spoil-setback", "pipe-bedding-backfill", "pipe-flotation", "restrained-pipe-length", "hdd-pullback", "dust-control-water", "haul-road-resistance", "dump-truck-loads", "unit-cost-earthwork",
