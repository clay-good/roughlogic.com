...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-mechanic.js", "MECHANIC_RENDERERS", [
    ...
    "spring-wire-stress",
    "gear-tooth-bending-stress", "gear-dynamic-tooth-stress", "gear-contact-stress", "aerodynamic-drag-force", "vehicle-road-load-power", "planetary-gear-ratio", "band-brake-torque", "centrifugal-force", "torsion-spring-rate", "universal-joint-speed", "slider-crank-piston-position",
  ...
  declare("./calc-machining.js", "MACHINING_RENDERERS", [
    ...
    "bearing-l10-life", "bearing-max-load", "bearing-equivalent-load", "fatigue-safety-factor", "endurance-limit-marin", "power-screw-torque", "disk-clutch-torque", "euler-johnson-column", "thick-wall-cylinder-stress", "rack-and-pinion",
