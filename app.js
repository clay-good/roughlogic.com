...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-agriculture.js", "AGRICULTURE_RENDERERS", [
    ...
    // v17
    "irrigation-requirement", "cattle-stocking-rate", "grain-bin-capacity", "grain-bin-height-for-capacity", "bunker-silo-capacity",
  ...
  declare("./calc-survey.js", "SURVEY_RENDERERS", [
    ...
    "cogo-forward-point", "edm-slope-reduction", "leveling-curvature-refraction",
  ]);
