...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-construction.js", "CONSTRUCTION_RENDERERS", [
    ...
    // v3
    "drywall", "roofing-squares", "asphalt-tonnage", "asphalt-paving-speed", "aggregate", "mortar-mix",
  ...
  declare("./calc-earthwork.js", "EARTHWORK_RENDERERS", [
    "soil-swell-shrink", "haul-cycle-production", "loader-production", "dozer-production", "compaction-roller-production", "dewatering-rate",
