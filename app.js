...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-machining.js", "MACHINING_RENDERERS", [
    ...
    "bearing-l10-life", "bearing-max-load", "bearing-equivalent-load", "fatigue-safety-factor", "endurance-limit-marin", "power-screw-torque", "disk-clutch-torque", "euler-johnson-column", "thick-wall-cylinder-stress",
