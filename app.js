...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-drainage.js", "DRAINAGE_RENDERERS", [
    ...
    "manning-slope", "manning-pipe-capacity", "pipe-partial-flow-depth", "tr55-time-of-concentration", "composite-curve-number", "curve-number-runoff", "tr55-graphical-peak-discharge", "tr55-detention-storage", "culvert-inlet-control",
  ]);
