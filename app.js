...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-electrical.js", "ELECTRICAL_RENDERERS", [
    ...
    // v3
    "pulling-tension", "cable-reel-capacity", "wire-pulling-lubricant", "branch-circuit-wire-footage", "microinverter-branch-count", "welder-arc-circuit-conductor", "welder-resistance-circuit-conductor", "battery-inverter-dc-conductor", "cable-bend-radius", "pf-correction", "phase-balance",
