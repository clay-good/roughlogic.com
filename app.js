...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-plumbing.js", "PLUMBING_RENDERERS", [
    ...
    "channel-normal-depth", "trapezoidal-channel-flow", "fixture-clearance-check", "shower-compartment-check", "vent-terminal-check", "aav-install-check", "grab-bar-layout", "cleanout-layout", "water-service-pressure-check", "hydraulic-jump", "specific-energy",
  ...
  declare("./calc-construction.js", "CONSTRUCTION_RENDERERS", [
    ...
    // v3
    "corner-bead-takeoff", "drywall", "roofing-squares", "asphalt-tonnage", "asphalt-paving-speed", "asphalt-tack-coat-quantity", "chip-seal-mcleod", "aggregate", "stockpile-volume", "mortar-mix",
    ...
    "guard-handrail-check", "guard-post-load", "egress-window-check", "landing-check", "door-maneuvering-clearance", "dryer-duct-length", "smoke-alarm-placement", "co-alarm-placement", "egress-window-well", "scaffold-guardrail-check", "excavation-protection-trigger", "scaffold-platform-check", "temporary-stairway-check",
  ...
  declare("./calc-masonry.js", "MASONRY_RENDERERS", [
    ...
    "masonry-wall-weight", "brick-veneer-anchor-spacing", "brick-veneer-weep-count", "masonry-joint-reinforcement", "masonry-lintel-loading", "masonry-lintel-bearing", "fireplace-flue-area",
