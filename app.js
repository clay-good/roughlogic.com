...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-electrical.js", "ELECTRICAL_RENDERERS", [
    ...
    // v3
    "pulling-tension", "cable-reel-capacity", "wire-pulling-lubricant", "cable-bend-radius", "pf-correction", "phase-balance",
  ...
  declare("./calc-construction.js", "CONSTRUCTION_RENDERERS", [
    ...
    "shore-post-load", "scaffold-mudsill-bearing", "scaffold-leg-load", "scaffold-takeoff", "asphalt-spread-rate", "pavement-milling-production", "striping-paint-quantity", "concrete-vibrator-spacing", "formwork-tie-load", "mass-concrete-temp-rise", "concrete-washout-volume", "shingle-nails", "duct-metal-weight", "concrete-evaporation-rate", "concrete-strength-gain",
