...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-agriculture.js", "AGRICULTURE_RENDERERS", [
    ...
    // v17
    "irrigation-requirement", "mad-irrigation-trigger", "fertigation-injection-rate", "cattle-heart-girth-weight", "corn-yield-estimate", "cattle-stocking-rate", "grain-bin-capacity", "grain-bin-height-for-capacity", "bunker-silo-capacity", "feed-conversion-ratio",
  ...
  declare("./calc-rigging.js", "RIGGING_RENDERERS", [
    ...
    "roller-jack-force", "chain-lever-hoist", "block-redirect-load", "block-redirect-max-angle", "reeving-parts-of-line",
