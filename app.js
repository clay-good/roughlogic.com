...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-edu.js", "EDU_RENDERERS", [
    ...
    // v20
    "final-grade-needed", "category-weighted-grade", "two-sample-t-test", "paired-t-test", "one-sample-t-test", "one-way-anova", "chi-square-independence", "spearman-rank-correlation",
  ]);
