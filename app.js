...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-solar.js", "SOLAR_RENDERERS", [
    ...
    "pv-energy-yield", "pv-array-sizing", "pv-row-spacing", "pv-inverter-ratio",
  ...
  declare("./calc-mechanic.js", "MECHANIC_RENDERERS", [
    ...
    "hydraulic-pump-horsepower", "hydraulic-motor-torque-speed", "hydraulic-pump-flow", "cooling-system-flow",
    ...
    "injector-size", "mean-piston-speed", "max-rpm-from-piston-speed", "trap-speed-horsepower",
