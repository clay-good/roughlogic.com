...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-plumbing.js", "PLUMBING_RENDERERS", [
    ...
    // v3
    "stormwater-rational", "manning-slope", "manning-pipe-capacity", "hydrostatic-test", "grease-trap", "grease-interceptor-flow-capacity",
  ...
  declare("./calc-concrete.js", "CONCRETE_RENDERERS", [
    ...
    "concrete-elastic-modulus", "concrete-strength-from-modulus", "concrete-modulus-of-rupture", "concrete-strength-from-rupture", "concrete-cracking-moment", "concrete-shrinkage-temperature-steel",
  ...
  declare("./calc-geotech.js", "GEOTECH_RENDERERS", [
    ...
    "soil-settlement-elastic", "elastic-settlement-allowable-pressure", "pile-axial-capacity", "pile-length-for-capacity", "slope-stability-infinite", "slope-stability-seepage",
  ...
  declare("./calc-agriculture.js", "AGRICULTURE_RENDERERS", [
    ...
    // v17
    "irrigation-requirement", "cattle-stocking-rate", "grain-bin-capacity", "grain-bin-height-for-capacity",
  ...
  declare("./calc-water.js", "WATER_RENDERERS", [
    "pounds-formula", "filter-loading", "detention-time", "detention-basin-volume",
