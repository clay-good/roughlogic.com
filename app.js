...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-finish.js", "FINISH_RENDERERS", [
    ...
    "attic-ventilation", "soffit-ridge-vent-count", "gutter-downspout", "gutter-downspout-takeoff", "deck-board-takeoff", "rough-opening-size", "closet-shelf-takeoff", "countertop-overhang-support", "cabinet-linear-feet", "drip-edge-takeoff", "glass-weight",
