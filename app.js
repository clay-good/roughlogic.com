...
const TOOL_MODULES = (() => {
  ...
  declare("./calc-drainage.js", "DRAINAGE_RENDERERS", [
    ...
    "manning-slope", "manning-pipe-capacity", "pipe-partial-flow-depth", "tr55-time-of-concentration", "composite-curve-number", "curve-number-runoff", "tr55-graphical-peak-discharge", "tr55-detention-storage", "culvert-inlet-control", "box-culvert-inlet-control",
  ]);
  ...
  declare("./calc-steel.js", "STEEL_RENDERERS", [
    ...
    "steel-h1-interaction", "steel-b1-amplifier", "steel-effective-length-k", "steel-column-stiffness-ratio-g", "steel-tau-b-stiffness-reduction", "steel-bolt-tension-shear",
