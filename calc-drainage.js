...
// dims: in { runoff_volume_ft3: L^3, void_ratio: dimensionless, trench_depth_ft: L, infiltration_rate_in_hr: L T^-1 } out: { excavation_volume_ft3: L^3, footprint_sf: L^2, draindown_time_hr: T }
