...
CIVIL_RENDERERS["esal-traffic-loading"] = _simpleRenderer({
  ...
  outputs: [
    ...
    { key: "o", id: "etl-out-o", label: "Overload", value: (r) => r.overload_lef === null ? "(no overload axle entered)" : "an axle at " + fmt(r.overload_axle_lb, 0) + " lb does " + fmt(r.overload_lef, 2) + "x the damage of the 18,000 lb standard -- " + (r.overload_lef >= 1 ? fmt(r.overload_excess_pct, 0) + "% more, for a " + fmt((r.overload_axle_lb / r.standard_axle_lb - 1) * 100, 0) + "% overload" : fmt(-r.overload_excess_pct, 0) + "% less, for an axle " + fmt((1 - r.overload_axle_lb / r.standard_axle_lb) * 100, 0) + "% under the standard") },
