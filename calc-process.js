...
export const thermoplasticTemperatureDerateExample = { inputs: { rated_pressure_psi: 200, operating_temp_f: 120, derating_factor: 0.40, operating_pressure_psi: 100, max_rated_temp_f: 140, alt_derating_factor: 0.65 } };
// Spears Schedule 80 CPVC table: 0.65 at 120 F (0.82 is the 100 F row; the example used it until 2026-09-25,
// which put CPVC at 164 psi where the table gives 130).
...
export function computeMeltFurnaceEnergy({
  ...
  const metal_verdict = !has_alt_metal
    ...
    : "a metal at " + fmt(alt_theoretical_btu_lb, 0) + " BTU/lb theoretical takes " + fmt(alt_theoretical_btu_lb / theoretical_btu_lb, 2) + " times the energy per pound. Aluminium is the case that surprises everyone outside a foundry: at a melting point little more than half as high it still takes about 82% of iron's energy per pound (DOE: 493 against 600 BTU/lb), because its specific heat and its latent heat of fusion per pound are both much higher -- melting point is not what melting costs";
