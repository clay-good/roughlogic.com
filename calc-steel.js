...
STEEL_RENDERERS["shear-flow-connector-spacing"] = _simpleRenderer({
  ...
  fields: [
    { key: "shear_kip", label: "Transverse shear V at the section (kip)", kind: "number" },
    { key: "area_in2", label: "Connected element area A (in²)", kind: "number" },
    { key: "ybar_in", label: "Connected element centroid distance from NA, y_bar (in)", kind: "number" },
    { key: "inertia_in4", label: "Moment of inertia of whole section I (in⁴)", kind: "number" },
    { key: "connector_kip", label: "Capacity per connector R (kip)", kind: "number" },
    { key: "connectors_per_row", label: "Connectors per row n (2 = a pair of lines)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-beam-shear"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "cv1", label: "Web shear coefficient Cv1", kind: "number" },
    { key: "omega_v", label: "ASD safety factor Omega_v (1.50 or 1.67)", kind: "number" },
    { key: "vu", label: "Required shear Vu (kips, 0 to skip)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-column-capacity"] = _simpleRenderer({
  ...
  fields: [
    { key: "fy", label: "Yield stress Fy (ksi)", kind: "number" },
    { key: "e_mod", label: "Modulus E (ksi)", kind: "number" },
    { key: "k", label: "Effective-length factor K", kind: "number" },
    ...
    { key: "pu", label: "Required axial load Pu (kips, 0 to skip)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["bolt-group-eccentric"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "ncols", label: "Number of bolt columns", kind: "number" },
    { key: "nrows", label: "Number of bolt rows", kind: "number" },
    { key: "gage_in", label: "Column gage gx (in)", kind: "number" },
    { key: "pitch_in", label: "Row pitch gy (in)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["bolt-shear-bearing"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "ab_in2", label: "Bolt area Ab (in²)", kind: "number" },
    { key: "fnv_ksi", label: "Bolt shear stress Fnv (ksi)", kind: "number" },
    { key: "nplanes", label: "Shear planes (1 single, 2 double)", kind: "number" },
    { key: "t_in", label: "Connected ply thickness t (in)", kind: "number" },
    { key: "fu_ksi", label: "Material tensile strength Fu (ksi)", kind: "number" },
    { key: "le_in", label: "Edge distance le (in)", kind: "number" },
...
STEEL_RENDERERS["column-base-plate"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fc_ksi", label: "Concrete strength f'c (ksi)", kind: "number" },
    { key: "fy_ksi", label: "Plate yield Fy (ksi)", kind: "number" },
...
STEEL_RENDERERS["steel-cb"] = _simpleRenderer({
  ...
  fields: [
    { key: "mmax", label: "Max moment in the unbraced segment Mmax (kip-ft)", kind: "number" },
    { key: "ma", label: "Moment at the quarter point MA (kip-ft)", kind: "number" },
    { key: "mb", label: "Moment at midspan MB (kip-ft)", kind: "number" },
    { key: "mc", label: "Moment at the three-quarter point MC (kip-ft)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-beam-ltb"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "cb", label: "LTB modification factor Cb", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-block-shear"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fy", label: "Yield stress Fy (ksi)", kind: "number" },
    { key: "fu", label: "Tensile stress Fu (ksi)", kind: "number" },
    { key: "n", label: "Bolts in the shear line", kind: "number", attrs: { step: "1", min: "1" } },
    { key: "s_in", label: "Bolt spacing / pitch (in)", kind: "number" },
    { key: "end_in", label: "End distance (in)", kind: "number" },
    { key: "edge_in", label: "Tension edge distance (in)", kind: "number" },
    { key: "dh_in", label: "Hole diameter (in, bolt + 1/8)", kind: "number" },
    { key: "ubs", label: "Ubs (1.0 uniform, 0.5 nonuniform)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-tension-member"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "u_in", label: "Shear-lag U override (blank = compute)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-h1-interaction"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "mry_kft", label: "Required weak-axis moment Mry (kip-ft, 0 if none)", kind: "number" },
    { key: "mcy_kft", label: "Available weak-axis moment Mcy (kip-ft)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-b1-amplifier"] = _simpleRenderer({
  ...
  fields: [
    { key: "pr_kip", label: "Required axial compression Pr (kip)", kind: "number" },
    { key: "i_in4", label: "In-plane moment of inertia I (in⁴)", kind: "number" },
    { key: "lc1_ft", label: "Effective length in the plane K1 L (ft, K1 <= 1)", kind: "number" },
    ...
    { key: "m1_m2", label: "End-moment ratio, smaller/larger (- single curvature, + reverse; no transverse load)", kind: "number" },
...
STEEL_RENDERERS["steel-b2-amplifier"] = _simpleRenderer({
  ...
  fields: [
    { key: "pstory_kip", label: "Total story vertical load Pstory (kip)", kind: "number" },
    { key: "pmf_kip", label: "Moment-frame column load Pmf (kip, 0 = braced frame)", kind: "number" },
    { key: "h_kip", label: "Story shear H producing the drift (kip)", kind: "number" },
    { key: "l_ft", label: "Story height L (ft)", kind: "number" },
    { key: "drift_in", label: "First-order interstory drift under H (in)", kind: "number" },
    { key: "method", label: "Design basis", kind: "select", default: "LRFD", options: [
      { value: "LRFD", label: "LRFD (alpha = 1.0)" },
      { value: "ASD", label: "ASD (alpha = 1.6)" },
    ] },
...
STEEL_RENDERERS["steel-column-stiffness-ratio-g"] = _simpleRenderer({
  ...
  fields: [
    { key: "ic1", label: "Column 1 moment of inertia Ix (in⁴)", kind: "number" },
    { key: "lc1", label: "Column 1 length (ft)", kind: "number" },
    { key: "ic2", label: "Column 2 Ix (in⁴, continuing column; 0 to skip)", kind: "number" },
    { key: "lc2", label: "Column 2 length (ft, 0 to skip)", kind: "number" },
    { key: "ig1", label: "Girder 1 moment of inertia Ix (in⁴)", kind: "number" },
    { key: "lg1", label: "Girder 1 length (ft)", kind: "number" },
    { key: "ig2", label: "Girder 2 Ix (in⁴, 0 to skip)", kind: "number" },
    { key: "lg2", label: "Girder 2 length (ft, 0 to skip)", kind: "number" },
...
STEEL_RENDERERS["steel-tau-b-stiffness-reduction"] = _simpleRenderer({
  ...
  fields: [
    { key: "pr_kip", label: "Required axial compression Pr (kip)", kind: "number" },
    { key: "fy_ksi", label: "Yield strength Fy (ksi)", kind: "number" },
    { key: "ag_in2", label: "Gross area Ag (in²)", kind: "number" },
    { key: "method", label: "Design basis", kind: "select", default: "LRFD", options: [
      { value: "LRFD", label: "LRFD (alpha = 1.0)" },
      { value: "ASD", label: "ASD (alpha = 1.6)" },
...
STEEL_RENDERERS["steel-bolt-tension-shear"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fnv_ksi", label: "Nominal shear stress Fnv (ksi, 54 N / 68 X)", kind: "number" },
...
STEEL_RENDERERS["shear-stud-strength"] = _simpleRenderer({
  ...
  fields: [
    { key: "asc_in2", label: "Stud area Asc (in²)", kind: "number" },
    { key: "fc_psi", label: "Slab f'c (psi)", kind: "number" },
    { key: "ec_psi", label: "Concrete modulus Ec (psi)", kind: "number" },
    { key: "fu_ksi", label: "Stud tensile Fu (ksi)", kind: "number" },
    { key: "rg", label: "Group factor Rg (Table I8.1)", kind: "number" },
    { key: "rp", label: "Position factor Rp (Table I8.1)", kind: "number" },
...
STEEL_RENDERERS["composite-beam-flexure"] = _simpleRenderer({
  ...
  fields: [
    { key: "as_in2", label: "Steel area As (in²)", kind: "number" },
    { key: "fy_ksi", label: "Steel yield Fy (ksi)", kind: "number" },
    { key: "d_in", label: "Steel depth d (in)", kind: "number" },
    { key: "tslab_in", label: "Slab thickness (in)", kind: "number" },
    { key: "be_in", label: "Effective slab width be (in)", kind: "number" },
    { key: "fc_ksi", label: "Slab f'c (ksi)", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-camber"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "span_ft", label: "Simple span (ft)", kind: "number" },
    { key: "moi_in4", label: "Moment of inertia I (in⁴)", kind: "number" },
    { key: "e_ksi", label: "Modulus E (ksi)", kind: "number" },
    { key: "fraction", label: "Camber fraction of DL deflection", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["steel-inertia-for-deflection"] = _simpleRenderer({
  ...
  fields: [
    { key: "w_kip_ft", label: "Uniform (service) load (kip/ft)", kind: "number" },
    { key: "span_ft", label: "Simple span (ft)", kind: "number" },
...
STEEL_RENDERERS["steel-floor-vibration"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "damping_ratio", label: "Damping ratio beta", kind: "number" },
    { key: "walker_force_lb", label: "Walker force P0 (lb)", kind: "number" },
    { key: "limit_ratio", label: "Occupancy limit ao/g", kind: "number" },
  ],
  outputs: [
...
STEEL_RENDERERS["staggered-net-width"] = _simpleRenderer({
  ...
  fields: [
    { key: "plate_width_in", label: "Gross plate width (in)", kind: "number" },
    { key: "thickness_in", label: "Plate thickness (in)", kind: "number" },
    { key: "bolt_dia_in", label: "Bolt diameter (in)", kind: "number" },
    { key: "hole_allowance_in", label: "Hole allowance over the bolt diameter (in)", kind: "number" },
    { key: "gage_in", label: "Gage, transverse spacing between gage lines (in)", kind: "number" },
    { key: "pitch_in", label: "Pitch, longitudinal spacing between staggered holes (in)", kind: "number" },
    { key: "holes_straight", label: "Holes crossed by the straight chain", kind: "number" },
    { key: "holes_zigzag", label: "Holes crossed by the zigzag chain", kind: "number" },
    { key: "gage_spaces_zigzag", label: "Gage spaces crossed by the zigzag chain", kind: "number" },
  ],
  outputs: [
