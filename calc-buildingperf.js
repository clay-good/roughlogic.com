...
export function computeEffectiveLeakageArea({
  ...
  const convention_verdict = "on the Canadian 10 Pa convention the same house reports " + fmt(eqla_in2, 1) + " sq in of equivalent leakage area, " + fmt(convention_ratio, 2) + " times the US 4 Pa figure -- an identical building. About 1.15 of that ratio is the higher reference pressure and about 1.64 is the discharge coefficient (0.61 for the Canadian sharp-edged orifice against 1.0 in the US figure); a figure quoted without its convention cannot be compared with one quoted under the other";
