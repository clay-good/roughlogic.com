...
// $74 / $79 / $84) until 2026-09-02, so every reader was four dollars a day low
// at the standard tier and six low at the top of it.

export const GSA_PERDIEM_RATES = {
  AL: { lodging: 110, m_and_ie: 68 },
  AK: { lodging: 188, m_and_ie: 86 },
  AZ: { lodging: 124, m_and_ie: 74 },
  AR: { lodging: 110, m_and_ie: 68 },
  CA: { lodging: 168, m_and_ie: 80 },
  CO: { lodging: 142, m_and_ie: 74 },
  CT: { lodging: 142, m_and_ie: 74 },
  DC: { lodging: 257, m_and_ie: 86 },
  DE: { lodging: 124, m_and_ie: 68 },
  FL: { lodging: 134, m_and_ie: 74 },
  GA: { lodging: 124, m_and_ie: 68 },
  HI: { lodging: 215, m_and_ie: 92 },
  ID: { lodging: 110, m_and_ie: 68 },
  IL: { lodging: 158, m_and_ie: 80 },
  IN: { lodging: 110, m_and_ie: 68 },
  IA: { lodging: 110, m_and_ie: 68 },
  KS: { lodging: 110, m_and_ie: 68 },
  KY: { lodging: 110, m_and_ie: 68 },
  LA: { lodging: 124, m_and_ie: 74 },
  ME: { lodging: 134, m_and_ie: 74 },
  MD: { lodging: 158, m_and_ie: 80 },
  MA: { lodging: 188, m_and_ie: 86 },
  MI: { lodging: 124, m_and_ie: 68 },
  MN: { lodging: 134, m_and_ie: 74 },
  MS: { lodging: 110, m_and_ie: 68 },
  MO: { lodging: 110, m_and_ie: 68 },
  MT: { lodging: 110, m_and_ie: 68 },
  NE: { lodging: 110, m_and_ie: 68 },
  NV: { lodging: 142, m_and_ie: 74 },
  NH: { lodging: 134, m_and_ie: 74 },
  NJ: { lodging: 158, m_and_ie: 80 },
  NM: { lodging: 110, m_and_ie: 68 },
  NY: { lodging: 215, m_and_ie: 86 },
  NC: { lodging: 124, m_and_ie: 68 },
  ND: { lodging: 110, m_and_ie: 68 },
  OH: { lodging: 124, m_and_ie: 68 },
  OK: { lodging: 110, m_and_ie: 68 },
  OR: { lodging: 142, m_and_ie: 80 },
  PA: { lodging: 142, m_and_ie: 74 },
  RI: { lodging: 158, m_and_ie: 80 },
  SC: { lodging: 124, m_and_ie: 68 },
  SD: { lodging: 110, m_and_ie: 68 },
  TN: { lodging: 124, m_and_ie: 68 },
  TX: { lodging: 134, m_and_ie: 74 },
  UT: { lodging: 110, m_and_ie: 68 },
  VT: { lodging: 134, m_and_ie: 74 },
  VA: { lodging: 142, m_and_ie: 74 },
  WA: { lodging: 158, m_and_ie: 80 },
  WV: { lodging: 110, m_and_ie: 68 },
  WI: { lodging: 110, m_and_ie: 68 },
...
export function computeBoltProofLoad({ nominal_diameter_in = 0, threads_per_inch = 0, grade = "5" } = {}) {
  ...
  return {
    ...
    note: "SAE J429 bolt strength model: the strength acts on the tensile stress area at the thread root, At = 0.7854 x (D - 0.9743/n)^2, which is roughly 20-35% smaller than the nominal shank area (28% for a 1/2-13) (so a nominal-area estimate over-predicts capacity). Proof, yield, and tensile loads are At times the grade's proof, yield, and tensile strengths -- and the grade, read from the head markings, sets every number, so a Grade 2, Grade 5, and Grade 8 of identical diameter carry wildly different loads. The recommended clamp of about 75% of proof leaves margin for torque scatter and service loads -- the working target a torque value should aim for. A design aid; the joint design, torque method, and any preload requirement govern.",
  };
}
