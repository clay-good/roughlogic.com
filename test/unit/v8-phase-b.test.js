...
test("B.2 pipe-sizing cites its UPC-style WSFU basis against IPC Appendix E, IPC Table 709.1 (DFU) + Hunter (1940)", async () => {
  const t = await readCalc("calc-plumbing.js");
  assertCitationContains(t, ["Table E103.3(2)", "Table 709.1", "Hunter", "codes.iccsafe.org"], "pipe-sizing");
});
