...
const _TILES = [
  ...
  ["pulling-tension", "A"], ["cable-reel-capacity", "A"], ["wire-pulling-lubricant", "A"], ["branch-circuit-wire-footage", "A"], ["microinverter-branch-count", "A"], ["welder-arc-circuit-conductor", "A"], ["welder-resistance-circuit-conductor", "A"], ["battery-inverter-dc-conductor", "A"], ["pv-ac-output-circuit", "A"], ["cable-bend-radius", "A"], ["pf-correction", "A"],
  ...
  ["camera-lens-fov", "A"], ["camera-max-distance-for-ppf", "A"], ["ceiling-speaker-coverage", "A"], ["ceiling-speaker-coverage-angle", "A"], ["structured-cabling-channel", "A"], ["lv-cable-pull-footage", "A"], ["cable-support-jhook", "A"], ["access-control-power-supply", "A"], ["fire-alarm-nac-voltage-drop", "A"], ["loop-signal-scaling", "A"], ["rtd-resistance-to-temp", "A"],
  ...
  ["flash-gas-subcool", "C"],
  ["hydronic-buffer-tank", "C"], ["outdoor-reset-ratio", "C"],
