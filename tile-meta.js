...
const _TILES = [
  ...
  ["gear-mph-rpm", "K"],
  ["cutting-speed-rpm", "K"], ["thread-single-depth", "K"],
  ...
  ["camera-lens-fov", "A"], ["camera-max-distance-for-ppf", "A"], ["ceiling-speaker-coverage", "A"], ["ceiling-speaker-coverage-angle", "A"], ["structured-cabling-channel", "A"], ["lv-cable-pull-footage", "A"], ["cable-support-jhook", "A"], ["access-control-power-supply", "A"], ["fire-alarm-nac-voltage-drop", "A"], ["loop-signal-scaling", "A"], ["rtd-resistance-to-temp", "A"], ["pulse-flowmeter-k-factor", "A"], ["loop-voltage-budget", "A"], ["thermistor-beta-temp", "A"], ["dp-level-hydrostatic", "A"], ["pid-tuning-ziegler-nichols", "A"],
