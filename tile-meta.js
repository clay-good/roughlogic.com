...
const _TILES = [
  ...
  ["ev-charge-time", "A"], ["ev-range-per-hour", "A"], ["battery-series-parallel", "A"],
  ...
  ["irrigation-requirement", "L"], ["mad-irrigation-trigger", "L"], ["cattle-stocking-rate", "L"],
  ...
  ["overflow-scupper-sizing", "B"], ["scupper-width-for-flow", "B"], ["sewage-force-main-velocity", "B"], ["stormwater-detention-volume", "B"],
  ...
  ["chlorine-demand", "M"], ["dechlorination-dose", "M"], ["float-method-flow", "M"],
  ...
  ["shore-post-load", "E"], ["scaffold-mudsill-bearing", "E"], ["scaffold-leg-load", "E"], ["scaffold-takeoff", "E"], ["asphalt-spread-rate", "E"], ["pavement-milling-production", "E"], ["striping-paint-quantity", "E"], ["concrete-vibrator-spacing", "E"], ["formwork-tie-load", "E"], ["mass-concrete-temp-rise", "E"], ["concrete-washout-volume", "E"], ["shingle-nails", "E"], ["duct-metal-weight", "E"], ["duct-bank-concrete", "E"], ["duct-wrap-takeoff", "E"], ["duct-hanger-load", "E"], ["roof-underlayment-rolls", "E"], ["membrane-roof-takeoff", "E"], ["tapered-roof-insulation", "E"], ["sheathing-takeoff", "E"], ["construction-adhesive-tubes", "E"], ["sill-plate-anchor-count", "E"], ["metal-stud-takeoff", "E"], ["suspended-ceiling-grid", "E"], ["masonry-control-joint-layout", "E"], ["dumpster-count", "E"], ["sealant-joint-yield", "E"], ["self-leveler-bags", "E"], ["carpet-takeoff", "E"], ["sfrm-takeoff", "E"], ["spray-foam-board-feet", "E"], ["metal-deck-takeoff", "E"], ["rebar-tie-wire", "E"], ["anchor-epoxy-volume", "E"], ["baseplate-grout-volume", "E"], ["baluster-picket-count", "E"], ["traffic-taper-length", "E"], ["siding-takeoff", "E"], ["stucco-coverage", "E"], ["vapor-barrier-rolls", "E"], ["concrete-sawcut-footage", "E"], ["foundation-waterproofing-takeoff", "E"], ["curing-compound-coverage", "E"], ["concrete-isolation-joint", "E"], ["concrete-stair-volume", "E"], ["joist-hanger-count", "E"], ["drywall-fastener-takeoff", "E"], ["glass-vacuum-lift", "E"], ["polymeric-sand-bags", "E"], ["rigid-foam-board-count", "E"], ["roof-insulation-fasteners", "E"], ["housewrap-rolls", "E"], ["chain-link-fence-takeoff", "E"], ["curb-gutter-volume", "E"], ["rebar-chair-count", "E"], ["concrete-evaporation-rate", "E"], ["concrete-strength-gain", "E"],
