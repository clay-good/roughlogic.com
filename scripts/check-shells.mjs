...
const GROUP_GZIP_CAP = 92 * 1024; // spec-v1126 2026-07-27 (88->92 KB): the Group E construction hub crossed 90,305 B gz as the +100 campaign added its 12th construction tile; raised with tail headroom. Group shells are pre-rendered HTML, not in the app payload.
