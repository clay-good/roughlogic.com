...
const RELATED = {
  ...
  "fan-sheave-for-target-cfm": ["fan-affinity-laws", "fan-motor-bhp", "belt-pulley"],
  "fan-affinity-laws": ["fan-sheave-for-target-cfm", "fan-motor-bhp", "pump-specific-speed", "vfd-energy-savings", "duct-static-pressure-total"],
  "pitot-traverse-cfm": ["pitot-traverse-average", "duct-velocity-pressure", "fan-affinity-laws", "duct-sizing"],
  "pitot-traverse-average": ["pitot-traverse-cfm", "duct-velocity-pressure", "fan-affinity-laws", "grille-face-velocity"],
  ...
  "gear-undercut-backlash": ["spur-gear-geometry", "gear-tooth-bending-stress", "gear-chordal-thickness"],
  "spur-gear-geometry": ["gear-undercut-backlash", "gear-identification", "gear-cascade", "cutting-speed-rpm", "dividing-head", "gear-tooth-bending-stress"],
  ...
  "tiedown-count": ["axle-load-distribution","deck-point-load-dunnage","flatbed-tarp-size"],
  "kingpin-to-axle": ["axle-load-distribution","bridge-formula","oversize-permit-screen"],
  "safe-descent-speed": ["truck-startability","static-rollover-threshold","hydroplaning-speed"],
  "air-brake-pushrod-stroke": ["safe-descent-speed","truck-startability"],
  "oversize-permit-screen": ["bridge-formula","axle-load-distribution","kingpin-to-axle"],
  "hazmat-placard-threshold": ["oversize-permit-screen","tiedown-count"],
  "idle-fuel-cost": ["cost-per-mile","def-consumption","maintenance-reserve"],
  "flatbed-tarp-size": ["tiedown-count","deck-point-load-dunnage"],
  "deck-point-load-dunnage": ["tiedown-count","axle-load-distribution","flatbed-tarp-size"],
  ...
  "mwbc-voltage-drop": ["voltage-drop", "neutral-imbalance", "wire-ampacity"],
  "voltage-drop": ["mwbc-voltage-drop", "ohms-law", "wire-ampacity", "copper-resistance", "three-phase"],
  ...
  "elevator-handling-capacity": ["escalator-capacity","egress-capacity","occupant-load"],
  "glass-thickness-wind": ["glass-vacuum-lift","glass-weight","curtain-wall-mullion-deflection"],
  "awning-canopy-load": ["wind-solid-sign","snow-load","wind-pressure"],
  "garage-door-torsion-spring": ["torsion-spring-rate","helical-spring-rate","spring-wire-stress"],
  "window-film-shgc": ["window-solar-heat-gain","window-overhang-shade","igu-u-factor"],
  "igu-u-factor": ["window-solar-heat-gain","surface-condensation-risk","wall-condensation-gradient"],
  "escalator-capacity": ["elevator-handling-capacity","occupant-load","egress-capacity"],
  "dust-collection-duct": ["duct-sizing","duct-velocity-pressure","pipe-velocity"],
  "carburetor-altitude-jetting": ["air-density-correction","density-altitude","gas-altitude-derate"],
  // spec-v1435..v1444: the 2026-08-26 trade-expansion industrial and finishing band.
  "pneumatic-cylinder-scfm": ["air-receiver","hydraulic-cylinder","compressor-displacement"],
  "bucket-elevator-capacity": ["screw-conveyor","screw-conveyor-rpm","belt-conveyor-tension-power"],
  "cyclone-separator-sizing": ["dust-collection-duct","particle-settling-velocity","duct-velocity-pressure"],
  "gas-strut-force": ["helical-spring-rate","torsion-spring-rate","garage-door-torsion-spring"],
  "spray-booth-airflow": ["hood-exhaust","infiltration-load","powder-coating-coverage"],
  "powder-coating-coverage": ["paint-coverage","spray-booth-airflow","plating-tank-current"],
  "plating-tank-current": ["sacrificial-anode-life","nernst-equation","powder-coating-coverage"],
  ...
  "extension-ladder-overlap": ["ladder-angle", "portable-ladder-setup", "fall-protection-clearance", "roofing-squares"],
  "portable-ladder-setup": ["ladder-angle", "extension-ladder-overlap", "fall-arrest-anchorage", "roofing-squares"],
  "swing-fall-geometry": ["fall-protection-clearance", "fall-arrest-clearance", "ladder-angle"],
  "fall-arrest-anchorage": ["fall-arrest-clearance", "swing-fall-geometry", "scaffold-guardrail-check", "guard-post-load"],
  ...
  "cistern-storage-days": ["detention-time", "ro-recovery-concentration", "filter-loading"],
  ...
  "line-array-splay": ["spl-distance","acoustic-gain-pag-nag","delay-tower-alignment"],
  "delay-tower-alignment": ["time-alignment","line-array-splay","spl-distance"],
  "cardioid-sub-array": ["driver-spacing-lobing","delay-tower-alignment","line-array-splay"],
  "driver-spacing-lobing": ["cardioid-sub-array","line-array-splay","speaker-impedance"],
  "wireless-intermod": ["rf-antenna-cable-loss","wireless-link-budget","dmx-planner"],
  "rf-antenna-cable-loss": ["wireless-intermod","wireless-link-budget","dmx-planner"],
  "chain-hoist-lift-time": ["rigging-check","truss-capacity","counterweight-arbor-load"],
  "gobo-image-size": ["lighting-beam","lighting-throw-for-pool","mired-gel-shift"],
  "mired-gel-shift": ["gobo-image-size","lighting-beam","projector-brightness"],
  "haze-machine-sizing": ["gobo-image-size","lighting-beam","power-distro"],
  "stage-deck-live-load": ["truss-capacity","rigging-check","chain-hoist-lift-time"],
  "video-wall-data-rate": ["led-video-wall","projector-brightness","power-distro"],
  "outdoor-stage-wind": ["stage-deck-live-load","truss-capacity","rigging-check"],
  ...
  "ice-machine-sizing": ["pan-conversion","cooling-curve","hot-holding-energy"],
  "warewasher-hot-water": ["kitchen-sanitizer-ppm","hot-holding-energy","steam-kettle-heatup"],
  "freezing-time-plank": ["thaw-time","cooling-curve","sous-vide-pasteurization"],
  "thaw-time": ["freezing-time-plank","cooling-curve","tphc-window"],
  "fryer-oil-turnover": ["plate-cost","food-cost-percentage","prime-cost"],
  "keg-yield": ["pour-cost","draft-beer-line-balance","beverage-co2-duration"],
  "beverage-co2-duration": ["keg-yield","draft-beer-line-balance","pour-cost"],
  "dough-ball-scaling": ["bakers-percentage","dough-water-temperature","fermentation-time-q10"],
  "fermentation-time-q10": ["dough-water-temperature","bakers-percentage","dough-ball-scaling"],
  "covers-per-labor-hour": ["prime-cost","food-cost-percentage","menu-engineering"],
  "par-level-order": ["as-purchased-quantity","food-cost-percentage","recipe-scale"],
  "tphc-window": ["cooling-curve","thaw-time","sous-vide-pasteurization"],
  "steam-kettle-heatup": ["pan-conversion","hot-holding-energy","warewasher-hot-water"],
  "hot-holding-energy": ["steam-kettle-heatup","ice-machine-sizing","warewasher-hot-water"],
  ...
  "egc-sizing": ["egc-parallel-raceways", "wire-ampacity", "grounding-electrode", "breaker-sizing"],
  "egc-parallel-raceways": ["egc-sizing", "egc-upsize-proportional", "parallel-conductor-derate"],
  ...
  "tr55-time-of-concentration": ["time-of-concentration","stormwater-rational","curve-number-runoff","stormwater-detention-volume"],
  "curve-number-runoff": ["stormwater-rational","tr55-time-of-concentration","stormwater-detention-volume","time-of-concentration"],
  ...
  "condensing-flue-condensate": ["flue-gas-dew-point", "condensate-drain", "gas-appliance-demand"],
  ...
  "chip-seal-mcleod": ["asphalt-tack-coat-quantity", "asphalt-spread-rate", "aggregate"],
  "asphalt-tack-coat-quantity": ["chip-seal-mcleod", "asphalt-tonnage", "asphalt-paving-speed", "coating-coverage-dft"],
  ...
  "barstock-cutlist": ["bar-nesting", "coil-length", "metal-weight", "weld-cost-per-foot"],
  "bar-nesting": ["barstock-cutlist", "metal-weight", "coil-length", "weld-cost-per-foot"],
  ...
  "accessible-route-width": ["protruding-object-check", "ada-ramp-slope", "door-clear-width", "landing-check"],
  "door-clear-width": ["door-maneuvering-clearance", "accessible-route-width", "rough-opening-size", "floor-level-change"],
  "floor-level-change": ["ada-ramp-slope", "accessible-route-width", "door-clear-width", "turning-clear-floor-space"],
  "turning-clear-floor-space": ["accessible-route-width", "reach-range", "door-maneuvering-clearance", "handrail-geometry"],
  ...
  "noise-dose": ["heat-stress", "niosh-lifting", "hearing-protector-nrr"],
  "hearing-protector-nrr": ["noise-dose", "decibel-converter", "silica-table-1", "niosh-lifting"],
  "silica-table-1": ["hearing-protector-nrr", "noise-dose", "dust-control-water", "lifeline-tension"],
  "lifeline-tension": ["fall-protection-clearance", "swing-fall-geometry", "silica-table-1", "guard-post-load"],
  ...
  "gear-tooth-bending-stress": ["gear-dynamic-tooth-stress", "spur-gear-geometry", "gear-mph-rpm", "belt-hp-transmitted"],
  "gear-dynamic-tooth-stress": ["gear-tooth-bending-stress", "spur-gear-geometry", "gear-undercut-backlash", "motor-shaft-torque"],
  ...
  "duct-static-regain": ["duct-velocity-pressure", "duct-static-pressure-total", "duct-transition-length"],
  ...
  "reeving-parts-of-line": ["chain-lever-hoist", "pulley-ma-gen", "rope-ma"],
  "guy-wire-tension": ["tagline-force", "sling-angle", "block-redirect-load"],
  ...
  "membrane-roof-takeoff": ["membrane-fastener-takeoff", "roofing-squares", "metal-roof-panels", "roof-underlayment-rolls"],
  "membrane-fastener-takeoff": ["membrane-roof-takeoff", "roof-insulation-fasteners", "tapered-roof-insulation", "roofing-squares"],
  ...
  "carpet-takeoff": ["carpet-seam-layout", "flooring-takeoff", "self-leveler-bags", "carpet-restore-replace"],
  "carpet-seam-layout": ["carpet-takeoff", "flooring-takeoff", "wallpaper-rolls", "self-leveler-bags"],
  ...
  "advance-warning-sign-spacing": ["traffic-taper-length", "stopping-sight-distance", "striping-paint-quantity"],
  "traffic-taper-length": ["advance-warning-sign-spacing", "striping-paint-quantity", "asphalt-paving-speed", "ada-ramp-slope"],
  "siding-takeoff": ["siding-course-layout", "metal-roof-panels", "fence-estimate", "sheathing-takeoff"],
  "siding-course-layout": ["siding-takeoff", "equal-spacing", "housewrap-rolls"],
  ...
  "stairwell-pressurization": ["smoke-detector-spacing-count","sprinkler-system-demand"],
  "fire-tank-sizing": ["sprinkler-system-demand","fire-pump-curve","required-fire-flow"],
  "ppv-fan-sizing": ["smoke-reading","hose-lay-section-count"],
  "hose-lay-section-count": ["fire-friction","pdp","ppv-fan-sizing"],
  "sprinkler-obstruction": ["sprinkler-head-layout","sprinkler-system-demand","sprinkler-density"],
  "fdc-supply-check": ["standpipe-friction","pdp","fire-friction"],
  "radiant-exposure-separation": ["required-fire-flow","master-stream"],
  "hydrant-spacing-count": ["required-fire-flow","hydrant-flow","fire-tank-sizing"],
  ...
  "formwork-member-spacing": ["formwork-pressure", "formwork-tie-load", "shore-post-load"],
  "formwork-tie-load": ["formwork-member-spacing", "formwork-pressure", "shore-post-load", "concrete-pour-rate"],
  ...
  "tree-appraisal-ctla": ["trunk-decay-strength", "tree-protection-zone", "tree-height-clinometer"],
  ...
  "retaining-wall-block": ["paver-patio","aggregate","masonry-count","srw-geogrid-spacing"],
  "srw-geogrid-spacing": ["retaining-wall-block","retaining-wall-stability","lateral-earth-pressure","aggregate"],
  ...
  "drip-edge-takeoff": ["roofing-squares","step-flashing-count","valley-flashing-takeoff"],
  ...
  "hydraulic-line-velocity": ["hydraulic-pump-flow","hydraulic-drive-flow-limit","pipe-velocity"],
  "hydraulic-pump-flow": ["hydraulic-line-velocity","hydraulic-pump-horsepower","hydraulic-motor-torque-speed","hydraulic-cylinder","cooling-system-flow"],
  ...
  "condensate-drain": ["condensate-overflow-pan","condensate-trap-depth","cfm-per-ton","manual-j-cooling","duct-sizing"],
  "condensate-overflow-pan": ["condensate-drain","condensate-trap-depth","cfm-per-ton"],
  "condensate-trap-depth": ["condensate-drain","duct-static-pressure-total","filter-pressure-drop"],
  ...
  "txv-capacity-check": ["superheat-subcool","refrigerant-pt","head-pressure-control"],
  "defrost-cycle-sizing": ["walk-in-cooler-load","refrigerant-pt"],
  "damper-authority": ["valve-authority","duct-sizing"],
  "chilled-water-delta-t": ["valve-authority","pump-eff-w2w"],
  "refrigerant-leak-rate": ["recovery-cylinder","refrigerant-charge"],
  "refrigerant-recovery-time": ["recovery-cylinder","refrigerant-charge","vacuum-decay-test"],
  "head-pressure-control": ["txv-capacity-check","refrigerant-pt","superheat-subcool"],
  ...
  "injection-clamp-tonnage": ["injection-cooling-time","shot-size-residence-time","mold-shrinkage-dimension"],
  "shot-size-residence-time": ["injection-clamp-tonnage","injection-cooling-time","mold-shrinkage-dimension"],
  "injection-cooling-time": ["injection-clamp-tonnage","shot-size-residence-time","mold-shrinkage-dimension"],
  "mold-shrinkage-dimension": ["injection-cooling-time","injection-clamp-tonnage","thermoforming-draw-ratio"],
  "extrusion-output-rate": ["thermoforming-draw-ratio","hdpe-fusion-pressure-time","injection-cooling-time"],
  "thermoforming-draw-ratio": ["extrusion-output-rate","mold-shrinkage-dimension","injection-cooling-time"],
  "hdpe-fusion-pressure-time": ["thermoplastic-temperature-derate","extrusion-output-rate","pipe-volume"],
  "thermoplastic-temperature-derate": ["hdpe-fusion-pressure-time","water-hammer-surge","pipe-support-spacing"],
  "casting-pour-yield": ["riser-modulus-feeding","melt-furnace-energy","sand-permeability-vent"],
  ...
  "grille-neck-nc": ["grille-face-velocity","duct-breakout-noise","adpi-diffuser-selection"],
  "duct-breakout-noise": ["silencer-insertion-loss","grille-neck-nc","mechanical-room-nc"],
  "silencer-insertion-loss": ["duct-breakout-noise","mechanical-room-nc","grille-neck-nc"],
  "mechanical-room-nc": ["duct-breakout-noise","silencer-insertion-loss","door-undercut-transfer-air"],
  "rooftop-curb-uplift": ["asce7-load-combinations","seismic-overturning-stability","pv-ballast-weight"],
  ...
  "rc-tbeam-flexure": ["t-beam-effective-flange-width","rc-beam-flexure","rc-doubly-reinforced","concrete-beam-min-flexural-steel"],
  ...
  "lateral-earth-pressure": ["retaining-wall-stability","soil-bearing-capacity","spoil-setback","cohesive-earth-pressure"],
  ...
  "soil-vertical-effective-stress": ["liquefaction-screening","soil-consolidation-settlement","submerged-earth-pressure","soil-bearing-capacity"],
  ...
  "concrete-anchor-breakout": ["concrete-anchor-shear-breakout","anchor-embedment","column-base-plate","masonry-anchor-bolt"],
  ...
  "snow-guard-layout": ["sliding-snow-load","snow-load","metal-roof-panels"],
  "sliding-snow-load": ["snow-guard-layout","snow-load","snow-drift-load","minimum-roof-snow","rain-on-snow-surcharge"],
  ...
  "overconsolidated-settlement": ["soil-consolidation-settlement","consolidation-time-rate","settlement-limit-load","soil-vertical-effective-stress"],
  "soil-consolidation-settlement": ["overconsolidated-settlement","settlement-limit-load","soil-settlement-elastic","soil-bearing-capacity","consolidation-time-rate"],
  ...
  "taping-corrections": ["taping-normal-tension","differential-leveling","stadia-distance","traverse-closure"],
  "taping-normal-tension": ["taping-corrections","differential-leveling","stadia-distance","edm-slope-reduction"],
  "cogo-forward-point": ["traverse-closure","area-by-coordinates","azimuth-bearing-conversion"],
  ...
  "cogo-inverse-locate": ["cogo-forward-point","azimuth-bearing-conversion","traverse-closure"],
  "azimuth-bearing-conversion": ["cogo-inverse-locate","cogo-forward-point","bearing-conversion","traverse-closure"],
  ...
  "belt-deflection-tension": ["vbelt-drive","belt-hp-transmitted","belt-pulley","bearing-l10-life"],
