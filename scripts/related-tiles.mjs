...
const RELATED = {
  ...
  "led-tape-run": ["voltage-drop","power-distro","led-video-wall"],
  ...
  "hydraulic-pump-horsepower": ["hydraulic-cylinder","hydraulic-motor-torque-speed","vbelt-drive","hp-from-torque"],
  "hydraulic-motor-torque-speed": ["hydraulic-pump-horsepower","hydraulic-cylinder","hp-from-torque","gear-cascade"],
