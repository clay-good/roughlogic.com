...
const RELATED = {
  ...
  "handrail-geometry": ["guard-handrail-check", "ada-ramp-slope", "stair-stringer-layout", "landing-check"],
  ...
  "silica-table-1": ["hearing-protector-nrr", "noise-dose", "dust-control-water", "heat-stress"],
