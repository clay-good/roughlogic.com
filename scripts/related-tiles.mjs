...
const RELATED = {
  ...
  "accessible-parking-count": ["ada-ramp-slope", "striping-paint-quantity", "asphalt-paving-speed", "traffic-taper-length", "sign-character-height"],
  ...
  "tactile-sign-mounting": ["sign-character-height", "door-clear-width", "door-maneuvering-clearance", "turning-clear-floor-space"],
