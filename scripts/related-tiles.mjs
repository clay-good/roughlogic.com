...
const RELATED = {
  ...
  "spur-gear-geometry": ["gear-identification", "gear-cascade", "cutting-speed-rpm", "dividing-head", "gear-tooth-bending-stress"],
  ...
  "countertop-overhang-support": ["glass-weight","material-quantity","trim-linear-footage"],
