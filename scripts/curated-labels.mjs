...
export const CURATED_OUTPUT_LABELS = {
  ...
  "pitot-traverse-average": { cfm: "Airflow (CFM)" },
  "pitot-traverse-cfm": { cfm: "Airflow (CFM)" },
  ...
  "search-track-spacing": { pod: "Probability of detection" },
  "seer-eer": { SEER: "SEER" },
  "seismic-earth-pressure": { kae: "Seismic active coefficient Kae", pae: "Total seismic thrust Pae (lb/ft)" },
  "seismic-overturning-moment": { k: "Distribution exponent k" },
  "seismic-vertical-distribution": { k: "Distribution exponent k" },
