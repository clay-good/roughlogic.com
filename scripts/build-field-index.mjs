...
const manifestText = JSON.stringify({
  ...
  asOf: EDITION_DATE,
  // "annual" is the cadence tier scripts/refresh-cadence.json records for this
  // folder and the freshness lint requires the two stamps to match verbatim. The
  // real cadence is every catalog change: --check regenerates these shards and
  // fails on any drift, which is a stricter gate than a date could be.
