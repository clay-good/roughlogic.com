...
// The result-key humanizer moved to the repo root as key-labels.js so the
// agent door can use the same fallback this page does -- see that file.
// Imported (not just re-exported) because this module calls it, and re-exported
// for the unit tests that import it from here.
export { humanizeKey };
