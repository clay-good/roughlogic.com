...
const CAPS = {
  ...
  "calc-construction.js": 95000, // spec-v242..v247 + v251..v253 2026-07-02 (75500->95000): +9 Group E tiles (IBC/IPC occupancy trio, cast-in-place concrete trio, IBC plan-review trio) -> ~79.0 KB gz; current + ~20% headroom. spec-v113 2026-06-20 (65000->75500): +1 guard-handrail-check tile -> ~62.7 KB gz (96.4%); +~20% headroom. v94+v96 2026-06-18 (62000->65000): +4 tiles (fence-estimate, post-hole-concrete, control-joint-spacing, rebar-lap-splice); built ~61.4 KB gz // v80 2026-06-16 (was 66000 at 95.0%): v25 site-civil bench (horizontal-curve, vertical-curve, earthwork-end-area, slope-stake-cut-fill) relocated to calc-civil.js (62.7->57.9 KB gz), lowered cap locks in the freed space (~93.3%); v70 2026-06-15 (70000->66000): 5 spec-v67 earthwork tiles relocated to calc-earthwork.js (68.3->62.7 KB). Prior: v69 (67000->70000) +2 coatings; v67 (64000->67000) +5 earthwork
