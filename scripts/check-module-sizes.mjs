...
const CAPS = {
  ...
  "calc-arborist.js": 10000, // spec-v563..v564 forestry batch (basal-area-prism, reineke-sdi) (8000) // v87 2026-06-16 new tree-care / arborist-rigging bench split out of calc-agriculture.js (5 tiles: log-limb-weight, tree-rigging-shock, felling-notch-hinge, porta-wrap-friction, chipper-debris; ~6.7 KB gz, lazy-loaded, not in the home-view payload, current + ~19% headroom)
