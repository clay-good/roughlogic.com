...
const CAPS = {
  ...
  "calc-survey.js": 10500, // spec-v766 cogo-forward-point 2026-07-14 (9000->10500): +1 Group P COGO forward-locate tile. spec-v631 level-loop-adjustment 2026-07-11 (8000->9000): +1 Group P survey tile (array in/out renderer) tipped it over the old cap; raised ~13% with headroom; lazy-loaded, not in home-view payload // // spec-v311..v313 2026-07-03 (5000->8000): +3 field-surveying depth tiles (differential-leveling, stadia-distance, taping-corrections) -> ~7.2 KB gz (90%); current + ~11% headroom; lazy-loaded, not in home-view payload
