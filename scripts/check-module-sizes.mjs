...
const CAPS = {
  ...
  "calc-water.js": 32000, // spec-v935 cistern-storage-days 2026-07-18 (30000->32000): +the spec-v926 RO, v927 Fe/Mn, and v935 cistern tiles took the module past 30000 B gz (was 95.7%); lazy-loaded, not in the home-view payload. spec-v764 chlorine-decay-constant 2026-07-14 (28500->30000): the chlorine-decay inverse tile (k from a bottle test). spec-v734 filter-area-for-loading 2026-07-14 (27000->28500): the filter-loading inverse tile. spec-v659 uv-required-exposure 2026-07-13 (24500->27000): the UV-dose inverse tile took the built module to ~24.6 KB gz (100.5% of the old cap); cap = current + ~10% headroom; lazy-loaded, not in the home-view payload // spec-v116 2026-06-20 (21000->24500): +2 disinfection tiles (chlorine-demand, uv-dose) -> ~20.3 KB gz (96.5%); +~20% headroom. v75 2026-06-15 (was 23500 at 95.8%): v20 Phase M bench (weir-flow, langelier-index, chemical-feed-pump) relocated to calc-treatment.js (22.5->19.0 KB gz), lowered cap locks in the freed space and clears the WARN; v20 2026-06-06 (19500->23500)
  "calc-treatment.js": 27500, // spec-v768 pool-volume 2026-07-14 (26000->27500): +1 Group M pool-volume geometry tile (shape select + note). spec-v742 clarifier-area-for-loading 2026-07-14 (24000->26000): the clarifier-surface-loading inverse tile. spec-v657/v658 TDS+weir inverses 2026-07-13 (21000->24000): +2 Group M inverse tiles (conductivity-from-tds, weir-head-from-flow) took the built module to ~21.2 KB gz (101.1% of the old cap); cap = current + ~13% headroom; lazy-loaded, not in the home-view payload // spec-v613 flocculator-paddle-power 2026-07-10 (18000->21000): +1 Group M tile -> ~18.2 KB gz (101.1%); raised to ~21 KB with headroom; lazy-loaded, not in home-view payload // spec-v573/v575/v576 wastewater-ops 2026-07-10 (15000->18000): +3 Group M tiles (digester-vs-loading, flocculation-g-value, chlorine-cylinder-withdrawal) crossed 15000 at v576. // spec-v405..v407 wastewater-ops 2026-07-04 (12000->15000): +3 Group M tiles (clarifier-surface-loading, bod-tss-loading-removal, tds-from-conductivity) -> ~10.0 KB raw (83.2% of the old cap); headroom for backlog; lazy-loaded // spec-v353..v355 2026-07-03 (8500->12000): +3 Group M pool chlorination/heating tiles (pool-chlorine-dose, pool-heater-btu, breakpoint-chlorination) -> ~9.8 KB gz; current + ~20% headroom. v93 2026-06-18 (6000->8500): +3 pool-chemistry dosing tiles (pool-alkalinity-adjust, pool-cya-dose, pool-salt-dose); built ~7.3 KB gz // v75 2026-06-15 new water-treatment bench split out of calc-water.js (3 tiles: weir-flow, langelier-index, chemical-feed-pump; ~4.6 KB gz, lazy-loaded, fits with headroom)
  ...
  "calc-survey.js": 15500, // spec-v776 grid-to-ground 2026-07-14 (13500->15500): +1 Group P state-plane grid-to-ground tile. spec-v771 leveling-curvature-refraction 2026-07-14 (12000->13500): +1 Group P curvature/refraction tile. spec-v769 edm-slope-reduction 2026-07-14 (10500->12000): +1 Group P total-station slope-reduction tile (mode select + note). spec-v766 cogo-forward-point 2026-07-14 (9000->10500): +1 Group P COGO forward-locate tile. spec-v631 level-loop-adjustment 2026-07-11 (8000->9000): +1 Group P survey tile (array in/out renderer) tipped it over the old cap; raised ~13% with headroom; lazy-loaded, not in home-view payload // // spec-v311..v313 2026-07-03 (5000->8000): +3 field-surveying depth tiles (differential-leveling, stadia-distance, taping-corrections) -> ~7.2 KB gz (90%); current + ~11% headroom; lazy-loaded, not in home-view payload
  ...
  "calc-stage.js": 30000, // v727 2026-07-14 (28000->30000): +1 inverse tile (projector-max-screen-size); built ~26.5 KB gz // v676 2026-07-13 (26000->28000): +2 more inverse tiles (spl-distance-for-level v673, lighting-throw-for-pool v676); built ~26.0 KB gz // v667 2026-07-13 (24000->26000): +2 inverse tiles (room-absorption-target v664, led-tape-max-run v667); built ~24.1 KB gz // spec-v542 counterweight-arbor-load (21500) // v92 2026-06-18 (18500->21500): +2 video tiles (led-video-wall, projector-brightness); built ~19.3 KB gz // v51 2026-06-12 + lighting-beam stage photometry (was 17000 v24); lazy-loaded, not in home payload
  ...
  "calc-mechanic.js": 54000, // spec-v928 dynamic-compression-ratio 2026-07-18 (52000->54000): +1 Group K engine-builder tile (slider-crank dynamic CR from intake-valve-closing) took the module past 52000 B gz (was 94.8%); lazy-loaded, not in the home-view payload. spec-v791/v794-v796 2026-07-14 (46000->52000): +engine-bmep + the aviation cluster (glidepath-descent-rate, turn-radius-bank, climb-gradient-roc); the module was at 99.4% before this batch; lazy-loaded, not in the home-view payload // spec-v770 helical-spring-rate 2026-07-14 (44000->46000): +1 Group K spring-rate tile + SPRING_MATERIALS map. // spec-v725 2026-07-14 (42000->44000): sweep-11 adds 2 mechanic inverse tiles (waterline-for-hull-speed, turbo-max-boost-for-charge-temp); the module was at 95.9% before this batch // v664-v691 inverse campaign 2026-07-13 (39000->42000): +4 Group K inverse tiles (crouch-hp-for-speed, chamber-cc-for-cr, hydraulic-drive-flow-limit, screw-conveyor-rpm) took the built copy to ~39.5 KB gz (101.3% of the old cap); cap = current + ~6% headroom; lazy-loaded, not in the home-view payload // spec-v660 max-rpm-from-piston-speed 2026-07-13 (36000->39000): the mean-piston-speed inverse tile took the built copy to ~36.0 KB gz (100.1% of the old cap); cap = current + ~8% headroom; lazy-loaded, not in the home-view payload // spec-v514..v516 2026-07-09 (32000->36000): +3 more Group K tiles (brake-pedal-hydraulic, dyno-correction-sae, aircraft-weight-balance) take the built copy to ~32.2 KB gz (100.5% of the old cap); cap = current + ~12% headroom for the remaining Group K campaign tiles; lazy-loaded, not in the home-view payload // spec-v505..v507 2026-07-09 (28000->32000): +3 more Group K marine/engine tiles (anchor-rode-scope, turbo-pressure-ratio, crouch-planing-speed) take the built copy to ~28.3 KB gz (101.1% of the old cap); cap = current + ~13% headroom for the remaining Group K campaign tiles; lazy-loaded, not in the home-view payload // spec-v500..v502 2026-07-09 (25000->28000): +3 Group K tiles (density-altitude, crosswind-component, hull-speed) take the built copy to ~26.4 KB gz (105.6% of the old cap); cap = current + ~6% headroom; lazy-loaded, not in the home-view payload // spec-v396..v398 fluid-power/cooling trio 2026-07-04 (19500->25000): +3 Group K tiles (hydraulic-pump-horsepower, hydraulic-motor-torque-speed, cooling-system-flow) -> ~18.5 KB raw (94.8% of the old cap); headroom for the remaining calc-mechanic tiles in the v375..v474 backlog; lazy-loaded, not in the home-view payload // v100 2026-06-18 (18000->19500): +1 auto-body tile (paint-mix-ratio); built ~17.9 KB gz // v76 2026-06-15 (was 19500 at 95.6%): machining bench (cutting-speed-rpm, drill-point-depth) relocated to calc-machining.js (18.6->16.8 KB gz), lowered cap locks in the freed space; v31 2026-06-10 cutting-speed-rpm (was 18500 v20 2026-06-06; 14000 orig)
  "calc-machining.js": 22500, // spec-v952 taylor-tool-life 2026-07-18 (21000->22500): +1 Group K tile (Taylor tool-life V*T^n=C) took the module to ~20.4 KB gz (97.0% of the old cap); +~10% headroom; lazy-loaded, not in home-view payload. spec-v775 gear-chordal-thickness 2026-07-14 (19500->21000): +1 Group K gear-tooth-caliper tile. spec-v733 countersink-diameter-from-depth 2026-07-14 (18000->19500): the countersink-depth inverse (2nd machining inverse this session, after v729/v732). spec-v729 drill-point-angle-from-length 2026-07-14 (16500->18000): the drill-point-angle inverse tile. spec-v711 spindle-max-mrr 2026-07-14 (15000->16500): the spindle-max-MRR inverse tile took the module to ~14.7 KB gz (97.9% of the old cap); cap = current + ~11% headroom; lazy-loaded, not in home-view payload // spec-v649 gear-identification 2026-07-13 (13000->15000): the gear-identification inverse tile took the built module to ~13.4 KB gz (102.7% of the old cap); cap = current + ~12% headroom; lazy-loaded, not in the home-view payload // spec-v504/v509 2026-07-09 (11000->13000): +2 Group K tiles (bearing-l10-life, countersink-depth) take the built copy to ~11.2 KB gz (102% of the old cap); cap = current + ~16% headroom; lazy-loaded, not in the home-view payload // spec-v317..v319 2026-07-03 (6500->11000): +3 machining depth tiles (radial-chip-thinning, boring-bar-deflection, ballnose-scallop-height) -> ~8.3 KB gz (75%); current + ~33% headroom; lazy-loaded, not in home-view payload
  ...
  "calc-fire.js": 38000, // spec-v738 smooth-bore-diameter-for-flow 2026-07-14 (36000->38000): the smooth-bore-flow inverse tile. spec-v723 foam-max-coverage-area 2026-07-14 (34000->36000): the foam-inverse tile took the module to ~32.1 KB gz (94.5% of the old cap); +~11% headroom // spec-v581 2026-07-10 (28000->34000): fire-ground water-supply batch v577-v581 (nfa-fireground-flow, relay-pump-distance, draft-lift-max, tanker-shuttle-flow, foam-eductor-limit) -> ~28.9 KB gz (85.0%); +~18% headroom. spec-v114 2026-06-20 (24500->28000): +1 smooth-bore-flow tile -> ~23.4 KB gz (95.4%); +~20% headroom. v82 2026-06-16 (was 27000 at 94.9%): v3 technical-rescue bench (confined-space-purge, rope-ma, sling-angle) relocated to calc-rescue.js (25.6->22.8 KB gz), lowered cap locks in the freed space; v20 2026-06-06 (24000)
  "calc-rescue.js": 9500, // spec-v779 fall-arrest-clearance 2026-07-14 (8000->9500): +1 Group F ANSI Z359 fall-clearance tile. spec-v540..v541 Group P batch (search-track-spacing, sweat-rate-hydration) (5500) // v82 2026-06-16: spec-v3 technical-rescue bench split out of calc-fire.js (built module ~4.4 KB gzipped, current + ~20% headroom); lazy-loaded, not in the home-view payload
  ...
  "calc-cross.js": 40000, // spec-v758 wind-chill-wind-speed 2026-07-14 (38000->40000): the wind-chill inverse tile. v675 2026-07-13 (36000->38000): +rainwater-catchment-area (rainwater-yield inverse); built ~36.7 KB gz // v36 2026-06-10 split: spec-v26+ fab/layout tiles moved to calc-fab.js (was 41000 at 96.6%; now ~31 KB with headroom restored)
  "calc-fab.js": 26000, // spec-v737 wire-feed-speed-for-deposition 2026-07-14 (24000->26000): the wire-feed-deposition inverse tile. v129..v134 2026-06-23 (16000->24000): +6 metal-trades tiles (weld-metal-volume, wire-feed-deposition, weld-transverse-shrinkage, weld-group-eccentric, min-bend-radius, shrink-fit); built ~19.8 KB gz, lazy-loaded, +~21% headroom; v85 2026-06-16 (13000->16000): +4 welding gas/cutting/cost tiles (shielding-gas-runtime, oxyfuel-cutting-gas, weld-preheat-fuel, weld-cost-per-foot); built ~14.1 KB, lazy-loaded; v56 2026-06-13 split (was 20000 at 96%): the 8 layout / shop-geometry tiles moved to calc-layout.js, leaving the pipe & conduit fabrication bench (~10.1 KB); v39 2026-06-11 had raised it to 20000 for the conduit suite; v36 2026-06-10 split out of calc-cross.js
  "calc-layout.js": 15000, // spec-v751 circular-arc-rise-from-radius 2026-07-14 (13500->15000): the circular-arc inverse tile. v56 2026-06-13 new layout & shop-geometry bench (8 tiles: center-of-gravity-2point, bolt-circle, decimal-to-fraction, sine-bar, thread-pitch, circular-arc, circle-from-3-points, polygon-miter; ~10.6 KB), split out of calc-fab.js once it reached 96% of its cap
  "calc-shop.js": 26500, // spec-v728 2026-07-14 (24500->26500): +press-fit-interference-for-force (press-fit-pressure inverse). spec-v721 2026-07-14 (22000->24500): sweep-11 adds 3 shop inverse tiles (thread-pitch-dia-from-wires, press-brake-max-thickness, press-fit-interference-for-force); the module was at 95.5% before this batch. v680 2026-07-13 (20000->22000): +feed-for-surface-finish (turning-surface-finish inverse); built ~20.1 KB gz // spec-v399..v400 fab shop-math 2026-07-04 (16000->20000): +2 Group G tiles (tolerance-stack-rss, cone-flat-pattern) -> ~14.4 KB raw (90.0% of the old cap); headroom for remaining backlog; lazy-loaded, not in home-view payload // v40 2026-06-11 new machine-shop & fab bench (10 tiles: machining-time, material-removal-rate, turning-surface-finish, taper-calc, dividing-head, thread-measure-wire, press-brake-tonnage, punch-force, weld-duty-cycle, carbon-equivalent; first-principles, fits with headroom)
  "calc-lowvoltage.js": 27000, // spec-v949 loop-voltage-budget 2026-07-18 (25500->27000): +1 Group A LV tile (2-wire loop-power voltage budget) took the module to ~22.8 KB gz (89.3% of the old cap); +~6% headroom; lazy-loaded, not in the home-view payload. spec-v948 pulse-flowmeter-k-factor 2026-07-18 (24000->25500): +1 Group A LV tile (turbine/paddlewheel flowmeter K-factor) took the module to ~21.9 KB gz (91.3% of the old cap); +~7% headroom; lazy-loaded, not in the home-view payload. spec-v947 rtd-resistance-to-temp 2026-07-18 (22500->24000): +1 Group A LV tile (IEC 60751 RTD resistance-to-temperature) took the module to ~20.8 KB gz (92.5% of the old cap); +~7% headroom; lazy-loaded, not in the home-view payload. spec-v946 loop-signal-scaling 2026-07-18 (21000->22500): +1 Group A LV tile (4-20 mA current-loop signal scaling) took the module to ~19.6 KB gz (93.3% of the old cap); +~7% headroom; lazy-loaded, not in the home-view payload. spec-v937 fire-alarm-nac-voltage-drop 2026-07-18 (19000->21000): +1 Group A LV tile (NFPA 72 NAC end-of-line voltage drop) took the module past 19000 B gz (was 96.0%); lazy-loaded, not in the home-view payload. spec-v929 access-control-power-supply 2026-07-18 (17500->19000): +1 Group A LV tile (door power supply / standby battery sizing) took the module past 17500 B gz (was 97.3%); lazy-loaded, not in the home-view payload. spec-v740/v741 2026-07-14 (15000->17500): 2 inverse tiles (ceiling-speaker-coverage-angle, camera-max-distance-for-ppf). v687/v693 inverse tiles 2026-07-13 (13000->15000): +standby-battery-runtime, +fiber-max-length -> ~13.3 KB gz (102% of old cap); lazy-loaded // spec-v456..v458 2026-07-04 (11000->13000): +3 AV/security/data tiles (camera-lens-fov, ceiling-speaker-coverage, structured-cabling-channel) -> ~11.8 KB gz (107% of the old cap); cap = current + ~10% headroom; lazy-loaded, not in the home-view payload // v28 2026-06-09 new low-voltage/data/security module (6 tiles, ~8.9 KB gzipped; cap = current + 20% headroom)
  "calc-pipefit.js": 22500, // spec-v765 boiler-horsepower 2026-07-14 (21000->22500): +1 ABMA/ASME boiler-HP/steam/EDR conversion tile. spec-v588 2026-07-10 (17000->21000): +1 steam orifice/PRV tile (steam-prv-napier) -> ~17.9 KB gz (85.0%); +~17% headroom; lazy-loaded, absent from home payload. spec-v199..v203 2026-06-24 (12700->17000): +4 tiles (condensate-return-sizing, branch-saddle-cutback, reducer-offset, flange-rating) -> ~14.5 KB gz (85.2%); +~17% headroom; lazy-loaded, absent from home payload. spec-v157..v162 2026-06-23 (5000->12700): +6 steamfitting / pressure-piping / pipe-support tiles (flash-steam-pct, steam-pipe-velocity, steam-trap-sizing, pipe-pressure-rating, pipe-filled-support-load, hanger-rod-sizing) -> ~10.3 KB gz; +~20% headroom; lazy-loaded, absent from home payload. v29 2026-06-09 new pipe/raceway field-layout module (3 tiles: cold-spring, raceway-expansion-fitting, pipe-spacing-rack; cap = current + ~20% headroom)
  "calc-metalair.js": 8000, // spec-v760 groove-weld-length-for-load 2026-07-14 (6000->8000): the groove-weld-strength inverse tile. v30 2026-06-09 new metal/air/refrigerant module (3 tiles: groove-weld-strength, duct-static-pressure-total, compression-ratio-refrig; cap = current + ~20% headroom)
  ...
  "calc-plumbing.js": 73000, // spec-v745 thrust-block-max-pressure 2026-07-14 (70000->73000): the thrust-block-sizing inverse tile. spec-v715 2026-07-14 (66000->70000): sweep-10 adds 2 plumbing inverse tiles (grease-interceptor-flow-capacity, stormwater-max-drainage-area); the module was at 97.6% before this batch. spec-v388 thrust-block-sizing 2026-07-03 (60000->66000): +1 hydraulics tile (thrust-block-sizing) -> ~57.4 KB raw (95.7% of the old cap); headroom for the remaining plumbing tiles in the v375..v474 backlog (v450-452); lazy-loaded, not in the home-view payload // spec-v112 2026-06-20 (52000->60000): +1 water-heater-storage-sizing tile -> ~49.9 KB gz (95.9%); +~20% headroom. v86 2026-06-16 (was 53000 at 98.9%): onsite-wastewater / septic bench (septic-tank, septic-drainfield, septic-dose-tank, septic-pumpout-interval, septic-lpp-orifice) relocated to calc-septic.js (52.4->48.6 KB gz), lowered cap locks in the freed space (~93.5%); v78 2026-06-15 (was 57500 at 95.2%): v63/v64 service bench relocated to calc-service.js (54.7->49.5 KB gz); v73 2026-06-15 (was 60000 at 96.2%): v62 storm-drainage bench relocated to calc-drainage.js; v64 2026-06-13 (57000->60000): +2 pipe-support-spacing / softener-sizing tiles
  "calc-septic.js": 9500, // spec-v757 septic-lpp-squirt-head 2026-07-14 (8000->9500): the septic-lpp-orifice inverse tile. spec-v704 2026-07-14 (7000->8000): +2 inverse tiles this session (septic-drainfield-capacity v700, septic-tank-for-interval v704) pushed the bench to ~6.5 KB gz (92% of the old cap); ~19% headroom restored. v86 2026-06-16 new onsite-wastewater / septic bench split out of calc-plumbing.js (5 tiles: septic-tank, septic-drainfield, septic-dose-tank, septic-pumpout-interval, septic-lpp-orifice; lazy-loaded, not in the home-view payload)
  ...
  "calc-construction.js": 165000, // spec-v862..v873 2026-07-17 (150000->165000): the roofing/framing/interior/masonry/demo/glazing/flooring batch (~12 more Group E tiles through self-leveler-bags) took the shared Group E module to ~143.5 KB gz (95.7% of the old 150000 cap); raised to 165000 for the campaign's remaining Group E tiles (a module split is the eventual preferred fix). spec-v850..v860 2026-07-17 (140000->150000): the roofing/HVAC-sheet-metal/electrical-underground batch (shingle-nails, duct-metal-weight, duct-bank-concrete, duct-wrap-takeoff, duct-hanger-load) took the shared Group E module to ~136 KB gz (97.1% of the old 140000 cap); raised to 150000 for the campaign's remaining Group E tiles (a module split is the eventual preferred fix). spec-v834+v835+v837+v838+v839 2026-07-17 (132000->140000): the construction-ops landing batch (scaffold-leg-load, scaffold-takeoff, asphalt-spread-rate, pavement-milling-production, striping-paint-quantity) took the shared Group E module to ~129.5 KB gz (98.1% of the old cap); raised to 140000 for headroom (a module split is the eventual preferred fix for this shared Group E module). spec-v480+v481 2026-07-08 (110000->132000): the seismic-overturning-moment (ASCE 7 12.8.5) and stair-code-check (IBC 1011) tiles brought the module to ~110.6 KB gz, at the old 110000 cap; +~20% headroom (a module split is the eventual preferred fix for this shared Group E module). spec-v341..v343 2026-07-03 (95000->110000): +3 Group E structural-mechanics tiles (cantilever-beam, section-properties, combined-stress-axial-bending) -> ~90.0 KB gz (97% of the old cap); +~20% headroom for the campaign's remaining construction batches (v359-v361). spec-v242..v247 + v251..v253 2026-07-02 (75500->95000): +9 Group E tiles (IBC/IPC occupancy trio, cast-in-place concrete trio, IBC plan-review trio) -> ~79.0 KB gz; current + ~20% headroom. spec-v113 2026-06-20 (65000->75500): +1 guard-handrail-check tile -> ~62.7 KB gz (96.4%); +~20% headroom. v94+v96 2026-06-18 (62000->65000): +4 tiles (fence-estimate, post-hole-concrete, control-joint-spacing, rebar-lap-splice); built ~61.4 KB gz // v80 2026-06-16 (was 66000 at 95.0%): v25 site-civil bench (horizontal-curve, vertical-curve, earthwork-end-area, slope-stake-cut-fill) relocated to calc-civil.js (62.7->57.9 KB gz), lowered cap locks in the freed space (~93.3%); v70 2026-06-15 (70000->66000): 5 spec-v67 earthwork tiles relocated to calc-earthwork.js (68.3->62.7 KB). Prior: v69 (67000->70000) +2 coatings; v67 (64000->67000) +5 earthwork
  "calc-finish.js": 12000, // spec-v900/v907 2026-07-17 (10000->12000): +gutter-downspout-takeoff + soffit-ridge-vent-count took the built copy to ~10.0 KB gz (102.4% of the old cap); raised generously to avoid frequent re-raises; lazy-loaded, not in the home-view payload // spec-v789/v798 2026-07-14 (8500->10000): +deck-board-takeoff + glass-weight took the built copy to ~9.0 KB gz (105.8% of the old cap); lazy-loaded, not in the home-view payload // v95 2026-06-18 new finish-and-site-carpentry take-off module (6 tiles: thinset-coverage, flooring-takeoff, paver-patio, retaining-wall-block, attic-ventilation, gutter-downspout; ~6.8 KB gz, lazy-loaded, not in the home-view payload, current + ~20% headroom)
  "calc-elecdesign.js": 14000, // spec-v750 luminaire-height-for-illuminance 2026-07-14 (12500->14000): the point-illuminance inverse tile. spec-v714 max-grid-resistance-for-touch 2026-07-14 (11000->12500): the GPR inverse tile took the module to ~10.7 KB gz (99.7% of the old cap); +~14% headroom. spec-v558 step-touch-voltage (8500) // spec-v365..v367 2026-07-03 (5000->8500): +3 Group A lighting light-loss/compliance tiles (lighting-light-loss-factor, lighting-uniformity-ratio, egress-lighting-check) -> ~6.7 KB gz; current + ~20% headroom. v101 2026-06-19 new electrician design/layout bench split out of calc-electrical.js (2 tiles: pull-box-sizing, lumen-method; ~2 KB gz, lazy-loaded, not in the home-view payload, current + ~20% headroom)
  ...
  "calc-earthwork.js": 34000, // spec-v844..v846 2026-07-17 (30000->34000): the equipment/site-logistics/estimating batch (haul-road-resistance, dump-truck-loads, unit-cost-earthwork) took the module past 28.6 KB gz (95.5% of the old 30000 cap); raised to 34000 for the campaign's remaining earthwork tiles; lazy-loaded, not in the home-view payload. spec-v831..v833 2026-07-17 (26000->30000): the underground-utility check trio (pipe-flotation v831, restrained-pipe-length v832, hdd-pullback v833) took the module to ~25.4 KB gz (100.0% of the old 26000 cap), so raised to 30000 for the vein's remaining earthwork tile (dust-control-watering v836) plus headroom; lazy-loaded, not in the home-view payload. spec-v826.. 2026-07-16 (20000->26000): the erosion/SWPPP BMP cluster continues (check-dam v826 + sediment-basin/erosion-blanket/hydroseed/construction-entrance v827-v830 queued); the v821-v825 compaction/erosion tiles took the module to ~19.0 KB gz (94.8% of the old 20000 cap), so raised to 26000 for the cluster's remaining ~5 tiles; lazy-loaded, not in the home-view payload. spec-v820+v821.. 2026-07-16 (15000->20000): the construction-ops erosion/compaction cluster (ripper-production v820 landed, water-for-compaction v821 + RUSLE/riprap/silt-fence v822-v825 queued) is a multi-tile Group E earthwork batch; ripper took the module to ~14.4 KB gz (95.7% of the old 15000 cap), so raised to 20000 for the cluster's remaining tiles; lazy-loaded, not in the home-view payload. spec-v809+v810 2026-07-16 (12500->15000): +2 construction-equipment production tiles (loader-production, dozer-production) -> ~12.7 KB gz (101.6% of the old cap); +~18% headroom for the remaining production vein (scraper, ripper, roller, compaction) landing beside them; lazy-loaded, not in the home-view payload. spec-v326..v328 2026-07-03 (8500->12500): +3 soil characterization/QC tiles (relative-compaction, soil-phase-relations, atterberg-indices) -> ~9.8 KB gz (78.4%); current + ~27% headroom; lazy-loaded, not in home-view payload
  ...
  "calc-motor.js": 16500, // spec-v945 motor-rms-hp 2026-07-18 (15000->16500): the duty-cycle RMS-horsepower tile took the module to ~14.1 KB gz (94.0% of the old cap); +~10% headroom; lazy-loaded, not in the home-view payload. spec-v944 motor-acceleration-time 2026-07-18 (13500->15000): the WK^2 across-the-line acceleration-time tile took the module to ~13.2 KB gz (97.9% of the old cap); +~11% headroom; lazy-loaded, not in the home-view payload. spec-v722 motor-max-hp-for-starting-current 2026-07-14 (12000->13500): the LRA inverse tile took the module to ~11.0 KB gz (91.6% of the old cap); +~13% headroom. spec-v557 vfd-reflected-wave (10000) // spec-v499/v521 2026-07-09 (7500->10000): +2 Group A tiles (motor-locked-rotor-kva, motor-fault-contribution) take the built copy over the old cap (was 95.7% at v499); cap = current + headroom; lazy-loaded, not in the home-view payload // spec-v278 2026-07-03 (6000->7500): +motor-overload-sizing took the built copy to 5775 B (96.3%); +~30% headroom. Lazy-loaded, absent from the home payload. // v129 2026-06-23 new motor analysis bench split out of calc-electrical.js to relieve its 100.1% cap (4 tiles: motor-synchronous-speed-slip, motor-shaft-torque, motor-operating-cost, multi-motor-feeder; ~4.7 KB gz)
