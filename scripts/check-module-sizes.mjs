...
const CAPS = {
  ...
  "calc-civil.js": 12500, // spec-v756 superelevation-safe-curve-speed 2026-07-14 (11000->12500): the superelevation V-inverse tile. spec-v335..v337 2026-07-03 (8000->11000): +3 Group E roadway geometric-design tiles (superelevation, vertical-curve-sight-distance, horizontal-sightline-offset) -> ~9.0 KB gz; current + ~20% headroom. v80 2026-06-16 new site-civil / roadway-geometry bench split out of calc-construction.js (4 tiles: horizontal-curve, vertical-curve, earthwork-end-area, slope-stake-cut-fill; ~6.6 KB gz, lazy-loaded, fits with headroom)
