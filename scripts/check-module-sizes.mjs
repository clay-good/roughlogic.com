...
const CAPS = {
  ...
  "calc-septic.js": 8000, // spec-v704 2026-07-14 (7000->8000): +2 inverse tiles this session (septic-drainfield-capacity v700, septic-tank-for-interval v704) pushed the bench to ~6.5 KB gz (92% of the old cap); ~19% headroom restored. v86 2026-06-16 new onsite-wastewater / septic bench split out of calc-plumbing.js (5 tiles: septic-tank, septic-drainfield, septic-dose-tank, septic-pumpout-interval, septic-lpp-orifice; lazy-loaded, not in the home-view payload)
