...
const CAPS = {
  ...
  "calc-shop.js": 24500, // spec-v721 2026-07-14 (22000->24500): sweep-11 adds 3 shop inverse tiles (thread-pitch-dia-from-wires, press-brake-max-thickness, press-fit-interference-for-force); the module was at 95.5% before this batch. v680 2026-07-13 (20000->22000): +feed-for-surface-finish (turning-surface-finish inverse); built ~20.1 KB gz // spec-v399..v400 fab shop-math 2026-07-04 (16000->20000): +2 Group G tiles (tolerance-stack-rss, cone-flat-pattern) -> ~14.4 KB raw (90.0% of the old cap); headroom for remaining backlog; lazy-loaded, not in home-view payload // v40 2026-06-11 new machine-shop & fab bench (10 tiles: machining-time, material-removal-rate, turning-surface-finish, taper-calc, dividing-head, thread-measure-wire, press-brake-tonnage, punch-force, weld-duty-cycle, carbon-equivalent; first-principles, fits with headroom)
