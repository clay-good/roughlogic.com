...
const CAPS = {
  ...
  "calc-geotech.js": 10000, // spec-v287..v289 2026-07-03 (7000->10000): +3 foundation depth tiles (soil-settlement-elastic, pile-axial-capacity, slope-stability-infinite) -> ~8.0 KB gz (79.8%); current + ~25% headroom; lazy-loaded, not in home-view payload // spec-v260..v262 2026-07-02 new shallow-foundation / earth-retaining geotech bench (3 tiles: soil-bearing-capacity, lateral-earth-pressure, retaining-wall-stability; built ~5.4 KB gz, lazy-loaded, not in home-view payload; cap = current + ~25% headroom)
