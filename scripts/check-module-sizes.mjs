...
const CAPS = {
  ...
  "calc-hvacservice.js": 6500, // v104 2026-06-20 4000->6500: +2 electrical-diagnostic tiles (hvac-equipment-circuit, run-capacitor-microfarad) take the bench to 4 tiles (~5.4 KB gz, lazy-loaded, not in the home-view payload, current + ~20% headroom)
