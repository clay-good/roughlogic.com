...
export const SALES_TAX_NEXUS = {
  ...
  IN: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Ind. Code 6-2.5-2-1; IN DOR remote-seller FAQ: $100,000 gross revenue, current or preceding calendar year; 200-transaction test removed eff. 2024-01-01 (SEA 228)", verified_on: "2026-09-04" },
  IA: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Iowa Code 423.14A", verified_on: "2025-01-15" },
  KS: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Kan. Stat. Ann. 79-3702(h)(1)(G)(i)(b) (SB 50 2021, eff. 2021-07-01; KDOR Notice 21-17). Subparagraph (F) is the constitutional catch-all, not the threshold.", verified_on: "2026-09-04" },
  ...
  TN: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Tenn. Code Ann. ch. 67-6; TN DOR out-of-state dealers page and Important Notice #20-14: $100,000 in Tennessee sales, no transaction test, threshold lowered from $500,000 eff. 2020-10-01", verified_on: "2026-09-04" },
