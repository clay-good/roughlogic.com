...
export const SALES_TAX_NEXUS = {
  ...
  AK: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "ARSSTC Uniform Code sec. 040(A) (no statewide tax; member municipalities): $100,000 statewide gross; transaction prong repealed 2025-01-01", verified_on: "2026-09-04" },
  AZ: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Ariz. Rev. Stat. 42-5044: $200,000 (2019), $150,000 (2020), $100,000 (2021 on); previous or current calendar year", verified_on: "2026-09-04" },
  AR: { sales_threshold_usd: 100000, transactions_threshold: 200,  combine: "or", citation: "Ark. Code Ann. 26-52-111(a)(1)-(2)", verified_on: "2026-09-09" },
  CA: { sales_threshold_usd: 500000, transactions_threshold: null, combine: null, citation: "Cal. Rev. & Tax. Code 6203; CDTFA Wayfair guidance (eff. 2019-04-01)", verified_on: "2026-09-04" },
  CO: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Colo. Rev. Stat. 39-26-102(3)(c)(I) (HB19-1240)", verified_on: "2026-09-09" },
  ...
  FL: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Fla. Stat. 212.0596(1)(b) (S.B. 50, eff. 2021-07-01; TAXABLE remote sales, previous calendar year)", verified_on: "2026-09-04" },
  GA: { sales_threshold_usd: 100000, transactions_threshold: 200,  combine: "or", citation: "O.C.G.A. 48-8-2(8)(M.1)-(M.2)", verified_on: "2026-09-09" },
  ...
  ID: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Idaho Code 63-3611(h): >$100,000 gross receipts delivered into Idaho, previous or current calendar year", verified_on: "2026-09-04" },
  ...
  IN: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Ind. Code 6-2.5-2-1 (SEA 228): $100,000 gross revenue, current or preceding calendar year; 200-transaction test removed 2024-01-01", verified_on: "2026-09-04" },
  IA: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Iowa Code 423.14A(3)(a): gross revenue EQUAL TO OR EXCEEDING $100,000, immediately preceding or current calendar year", verified_on: "2026-09-04" },
  KS: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Kan. Stat. Ann. 79-3702(h)(1)(G)(i)(b) (SB 50 2021; KDOR Notice 21-17): >$100,000, previous or current calendar year", verified_on: "2026-09-04" },
  ...
  NV: { sales_threshold_usd: 100000, transactions_threshold: 200,  combine: "or", citation: "Nev. Tax Comm'n Reg. LCB File No. R189-18 sec. 2(c), eff. 2018-09-27 (NAC ch. 372)", verified_on: "2026-09-04" },
  ...
  NM: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "NMSA 7-9-3.3 (gross receipts tax, not sales tax); NM Tax & Rev FYI-206: at least $100,000, previous calendar year", verified_on: "2026-09-04" },
  ...
  NC: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "N.C. Gen. Stat. 105-164.8; NCDOR remote sales: >$100,000 sourced to NC, previous or current calendar year", verified_on: "2026-09-04" },
  ND: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "N.D. Cent. Code 57-39.2-02.2: gross sales delivered in-state exceed $100,000 in the previous or current calendar year; no transaction test", verified_on: "2026-09-04" },
  ...
  OK: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Okla. Stat. tit. 68 sec. 1392(G) (SB 513, eff. 2019-11-01): $100,000 in the preceding or current calendar year; no transaction test", verified_on: "2026-09-04" },
  PA: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Act 13 of 2019; PA DOR Sales & Use Tax Bulletin 2019-01: $100,000 annual PA gross sales, prior calendar year, no transaction test", verified_on: "2026-09-04" },
  ...
  SC: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "S.C. Code Ann. 12-36-70, applied by SC Rev. Rul. #18-14: $100,000 GROSS revenue incl. exempt and wholesale, prev. or current year", verified_on: "2026-09-04" },
  SD: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "S.D. Codified Laws ch. 10-64; SD DOR bulletin Aug 2025: >$100,000 gross, previous or current calendar year", verified_on: "2026-09-04" },
  TN: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Tenn. Code Ann. ch. 67-6; TN DOR Important Notice #20-14: $100,000 Tennessee sales, no transaction test; lowered from $500,000 on 2020-10-01", verified_on: "2026-09-04" },
  TX: { sales_threshold_usd: 500000, transactions_threshold: null, combine: null, citation: "Tex. Tax Code 151.107(a)(8); Comptroller Rule 3.286; Pub. 94-108 (total Texas revenue, preceding 12 months)", verified_on: "2026-09-04" },
  UT: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, combine_note: "2025 Utah Laws S.B. 47 struck the 200-transaction prong effective 2025-07-01; the sales threshold is now the only test.", citation: "Utah Code Ann. 59-12-107(2)(d)", verified_on: "2026-09-03" },
  VT: { sales_threshold_usd: 100000, transactions_threshold: 200,  combine: "or", citation: "Vt. Stat. Ann. tit. 32 sec. 9701(9)(F)(ii)", verified_on: "2026-09-03" },
  ...
  WI: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Wis. Stat. 77.51 small-seller exception (2021 Wis. Act 1): >$100,000 gross sales, previous or current calendar year", verified_on: "2026-09-04" },
  WY: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Wyo. Stat. Ann. 39-15-501(a)(i) (200-count prong repealed, Laws 2024 ch. 67 sec. 2): >$100,000, current or preceding year", verified_on: "2026-09-04" },
...
function renderSalesTaxNexus(inputRegion, outputRegion, citationEl) {
  ...
  function refresh() {
    ...
    const rows = [
      ...
      ["How the thresholds combine", r.transactions_threshold == null
        ? "Sales threshold only"
        : (r.combine === "and"
          ? "BOTH must be met (sales AND transactions)"
          : "EITHER one is enough (sales OR transactions)")],
      ["Citation", r.citation],
      ["Verified on", r.verified_on],
    ];
    if (r.combine_note) rows.splice(3, 0, ["Note", r.combine_note]);
