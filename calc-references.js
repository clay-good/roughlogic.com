...
export const SALES_TAX_NEXUS = {
  ...
  ID: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Idaho Code 63-3611(h): cumulative gross receipts from sales delivered into Idaho in excess of $100,000, previous or current calendar year; no transaction test", verified_on: "2026-09-04" },
  ...
  KS: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Kan. Stat. Ann. 79-3702(h)(1)(G)(i)(b) (SB 50 2021; KDOR Notice 21-17): >$100,000 cumulative gross receipts, current or immediately preceding calendar year", verified_on: "2026-09-04" },
  ...
  MO: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Mo. Rev. Stat. 144.605(2)(e) (SB 153): gross receipts from taxable sales delivered into MO exceed $100,000 in the previous or current calendar year; DOR determines quarterly over a trailing 12 months", verified_on: "2026-09-04" },
  ...
  NM: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "NMSA 7-9-3.3; NM Tax & Rev gross receipts overview (FYI-206): at least $100,000 taxable gross receipts in the PREVIOUS calendar year; gross receipts tax, not a sales tax", verified_on: "2026-09-04" },
  ...
  NC: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "N.C. Gen. Stat. 105-164.8; NCDOR remote sales: >$100,000 sourced to NC, previous or current calendar year; registration 60 days after crossing (eff. 2026-07-02)", verified_on: "2026-09-04" },
  ...
  SD: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "S.D. Codified Laws ch. 10-64; SD DOR Remote Seller Bulletin Aug 2025: >$100,000 gross sales, previous or current calendar year; 200-transaction test repealed 2023-07-01", verified_on: "2026-09-04" },
  ...
  WI: { sales_threshold_usd: 100000, transactions_threshold: null, combine: null, citation: "Wis. Stat. 77.51 small-seller exception (2021 Wis. Act 1): >$100,000 gross sales, previous or current calendar year; 200-transaction test ended 2021-02-20", verified_on: "2026-09-04" },
