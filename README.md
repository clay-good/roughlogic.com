...
> **416 deterministic tools across 24 trade groups. 0 dependencies. 0 trackers. 0 LLM calls. 4,778 unit tests. Works offline.**
...
| `npm test` / `npm run test:unit` | Run the unit suite under Node's built-in test runner (4,778 tests). |
