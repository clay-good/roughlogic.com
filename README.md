...
| `check-citation-coverage` | every tile names a real, dated source with all four required fields and no orphans. Freshness tracking is narrower: 1,484 tiles cite a source on a recheck calendar, and **699 cite a source no freshness tracker covers** |
