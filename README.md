...
> **515 deterministic tools across 24 trade groups. 0 dependencies. 0 trackers. 0 LLM calls. 5,425 unit tests. Works offline.**
...
| `npm test` / `npm run test:unit` | Run the unit suite under Node's built-in test runner (5,425 tests). |
