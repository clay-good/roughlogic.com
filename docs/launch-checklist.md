...
- **New tests (Phase E + Phase F scaffolding)**: [test/unit/numerical-stability.test.js](../test/unit/numerical-stability.test.js) (17 tests, 16 passing + 1 skipped follow-up) and [test/unit/cross-tile-invariants.test.js](../test/unit/cross-tile-invariants.test.js) (16 tests, all passing). Test-suite total: 3,476 (was 3,443 before Phase E / F scaffolding).
