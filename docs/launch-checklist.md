...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **1849 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **61 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **1872 live sitemap URLs** |
