...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **1869 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **64 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **1892 live sitemap URLs** |
