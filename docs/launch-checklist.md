...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2124 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **83 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2147 live sitemap URLs** |
