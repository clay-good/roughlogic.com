...
| 7. Home-view payload budget (`npm run check:home-payload`) passes | pass | **54,817 B / 102,400 B = 53.5 %** of cap (refreshed 2026-05-17 after the inline-notice fix added the five v12 per-group NOTICE constants). JS sub-budget tightest at **98.9 %** of 40 KB. v12 added zero runtime bytes to the home view; every new module is dynamic-imported on first tool open. |
