...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **1988 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **70 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2011 live sitemap URLs** |
