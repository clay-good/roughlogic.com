...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2026 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **73 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2049 live sitemap URLs** |
