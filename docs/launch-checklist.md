...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **1930 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **68 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **1953 live sitemap URLs** |
