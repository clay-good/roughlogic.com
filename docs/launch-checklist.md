...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2014 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **72 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2037 live sitemap URLs** |
