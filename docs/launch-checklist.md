...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **1893 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **67 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **1916 live sitemap URLs** |
