...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2098 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **80 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2121 live sitemap URLs** |
