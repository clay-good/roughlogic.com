...
- **npm scripts added**: `audit:corpus` (`build-corpus.mjs --check`), `corpus:build` (`build-corpus.mjs`, regenerates the section), (2026-05-19) `audit:cross-validation` (`check-cross-validation.mjs`), (2026-05-19) `audit:dimensions` (`check-dimensions.mjs`), and (2026-05-19) `audit:citation-coverage` (`check-citation-coverage.mjs --verbose`).
