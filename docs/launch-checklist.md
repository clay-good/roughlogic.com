...
| Figure | Live |
| --- | --- |
| Static gates in the `npm run lint` chain | **57 live lint gates** |
| Unit-test suite files under `test/unit/` | **162 live unit suites** |
| Playwright spec files under `test/integration/` | **23 live integration specs** |
