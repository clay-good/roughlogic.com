...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **1968 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **69 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **1991 live sitemap URLs** |
