...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2086 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **78 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2109 live sitemap URLs** |
