...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2052 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **76 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2075 live sitemap URLs** |
