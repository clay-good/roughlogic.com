...
| Figure | Live |
| --- | --- |
| Calculators (tiles) in `TOOLS` | **2006 live tiles** |
| Active catalog groups | **21 live groups** |
| `calc-*.js` modules | **71 live calc modules** |
| Sitemap URLs (one per tile, one per group hub, home, catalog hub) | **2029 live sitemap URLs** |
