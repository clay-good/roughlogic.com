...
2. Copies the static shell (index.html, styles.css, app.js, sw.js, manual-j-worker.js, all 59 calc-* modules from calc-electrical.js through calc-water.js (which include the v2 Group H reference module calc-references.js, the v28/v29/v30 calc-lowvoltage.js / calc-pipefit.js / calc-metalair.js, the v36 calc-fab.js split out of calc-cross.js, the v40 calc-shop.js machine-shop & fab bench, the v42 calc-gas.js fuel-gas bench split out of calc-plumbing.js, the v70 calc-earthwork.js earthwork/excavation bench split out of calc-construction.js, the v71 calc-survey.js coordinate/traverse surveying bench split out of calc-field.js, the v72 calc-feeder.js feeder & transformer-conductor overcurrent bench split out of calc-electrical.js, the v73 calc-drainage.js storm-drainage bench split out of calc-plumbing.js, the v74 calc-velocity.js duct/refrigerant-velocity bench split out of calc-hvac.js, the v75 calc-treatment.js water-treatment bench (weir-flow, langelier-index, chemical-feed-pump) split out of calc-water.js, the v76 calc-machining.js machining bench (cutting-speed-rpm, drill-point-depth) split out of calc-mechanic.js, the v77 calc-demo.js demolition/abatement take-off bench (moisture-dry-goal, flood-cut-quantity, abatement-containment) split out of calc-restoration.js, the v78 calc-service.js post-rough-in service bench (gas-appliance-demand, tpr-discharge, pipe-support-spacing, softener-sizing) split out of calc-plumbing.js, the v79 calc-powerquality.js advanced AC analysis bench (parallel-conductor-derate, neutral-current-3ph, motor-vd-starting) split out of calc-electrical.js, the v80 calc-civil.js site-civil / roadway-geometry bench (horizontal-curve, vertical-curve, earthwork-end-area, slope-stake-cut-fill) split out of calc-construction.js, the v81 calc-hvacsystems.js building-systems HVAC engineering bench (chiller-tons, hx-lmtd-ntu, air-changes-hour, boiler-pipe-sizing, compressor-short-cycle, humidifier-capacity, filter-pressure-drop) split out of calc-hvac.js, the v82 calc-rescue.js technical-rescue & confined-space bench (confined-space-purge, rope-ma, sling-angle) split out of calc-fire.js, the v86 calc-septic.js onsite-wastewater / septic bench (septic-tank, septic-drainfield, septic-dose-tank, septic-pumpout-interval, septic-lpp-orifice) split out of calc-plumbing.js, the v87 calc-arborist.js tree-care / arborist-rigging bench (log-limb-weight, tree-rigging-shock, felling-notch-hinge, porta-wrap-friction, chipper-debris) split out of calc-agriculture.js, the v88 calc-solar.js solar-PV / battery-storage / EV-charging bench (pv-string-sizing, battery-runtime, pv-interconnection-busbar, off-grid-battery, ev-charger-load) split out of calc-electrical.js, the v89 calc-refrigerant.js refrigerant-circuit bench (refrigerant-pt, superheat-subcool, compare-refrigerants, refrigerant-charge, refrigerant-charging) split out of calc-hvac.js, and the v95 calc-finish.js finish-and-site-carpentry take-off bench (thinset-coverage, flooring-takeoff, paver-patio, retaining-wall-block, attic-ventilation, gutter-downspout)), the support libs citations.js / tile-meta.js / limitation-banner.js / search-discovery.js / hash-state.js / clipboard.js / cost-output.js / v5-platform.js / theme.js, _headers, robots.txt, sitemap.xml, site.webmanifest, CHANGELOG.md, LICENSE). (The v2 `bundle.js` module was retired in commit 5734d28.)
...
4. The service worker registers and the page loads after going offline.
   ...
   applied. No shell is precached -- **1844 static shells** is not a precache -- so that
