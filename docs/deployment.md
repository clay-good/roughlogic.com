...
4. The service worker registers and the page loads after going offline.
   ...
   applied. No shell is precached -- **1855 static shells** is not a precache -- so that
