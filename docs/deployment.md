...
2. Copies the static shell (index.html, styles.css, app.js, sw.js, manual-j-worker.js, all calculator modules including the v2 modules calc-references.js and bundle.js, _headers, robots.txt, sitemap.xml, site.webmanifest, CHANGELOG.md, LICENSE).
