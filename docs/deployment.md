...
4. The service worker registers and the page loads after going offline.
   ...
   applied. No shell is precached -- **2155 static shells** is not a precache -- so that
