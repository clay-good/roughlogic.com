...
- v9 magnetic-declination shard (`data/field/wmm/coefficients.json`). NOAA / NCEI World Magnetic Model 2025 spherical-harmonic coefficients valid 2025-01-01 through 2029-12-31. Public-domain U.S. federal scientific data; the coefficients are factual measurements of the Earth's magnetic field, not creative work. Cited by name and cycle.
- v12 real-estate shards (`data/realestate/loan-limits.json`, `data/realestate/hud-fmr.json`). FHFA Conforming Loan Limit Values (annual), HUD FHA Single-Family Mortgage Limits (annual), and HUD PD&R Fair Market Rents (FY2026, 24 CFR Part 888). All sources are U.S. federal publications, public domain; the cited numbers are statutory or regulatory limits, not creative work. The VA full-entitlement no-cap policy is cited to the Blue Water Navy Vietnam Veterans Act of 2019 by name. Manifests carry `refresh_cadence: "annual"` per spec-v12 §H.2; the annual rollover is the recheck cadence (FHFA November, HUD October).
- v12 inline group tables (Groups U Veterinary / V EMS / W Pilots / Y Educators). These four v12 groups deliberately ship no new shards; the bundled tables (ASPCA APCC published thresholds, Lund-Browder TBSA bands, AAHA / AAFP life-stage factors, ICAO Standard Atmosphere coefficients, AHA PALS vital-sign ranges, IUPAC Standard Atomic Weights 2021, public-domain readability-formula constants from Kincaid 1975 / McLaughlin 1969 / Coleman-Liau 1975) live inline in the renderer modules. Each value is a published public-domain or factual measurement cited by author / agency / year per [citation-discipline.md](citation-discipline.md); no licensed text is reproduced. The clinical-utility carve-out from spec.md §11 is overridden for Groups U and V per [profession-overrides.md](profession-overrides.md), with the v10 §B.1 limitation banner as the safety affordance.
