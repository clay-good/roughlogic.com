...
| `fire-alarm-nac-voltage-drop` | Fire-Alarm NAC Circuit Voltage Drop (End-of-Line) | fire-alarm NAC voltage drop (NFPA 72); CUSTV = 0.85*24 = 20.4; loop R = 2*250*(3.14/1000) = 1.57... | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) (+1 more) |
...
| `shear-flow-connector-spacing` | Shear Flow and Connector Spacing (Built-Up Beam) | Mechanics of materials (shear flow q ...; Q = 6 x 8 = 48 in^3; q = 50 x 48 / 800 = 3.0 kip/in; s = ... | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) (+1 more) |
