...
| `cp-rectifier-sizing` | Cathodic Protection Rectifier Sizing | Project (first-principles); NACE SP0169 and the manufacturer govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `ac-induced-voltage-pipeline` | AC Induced Voltage and AC Corrosion Density | Project (first-principles); ISO 18086 and a corridor study govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `anode-bed-resistance` | Impressed Current Anode Bed Resistance | Project (first-principles); a Wenner survey and the CP designer govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `buffer-stroke-speed` | Elevator Buffer Stroke and Impact Speed | Project (first-principles); ASME A17.1 retardation limits named | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `coating-breakdown-factor` | Coating Breakdown Factor and CP Current Growth | Project (first-principles); DNV-RP-B401 and the CP designer govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `coke-breeze-backfill` | Coke Breeze Backfill Quantity | Project (first-principles); the supplier's data and the CP designer govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `step-chain-tension` | Escalator Step Chain Tension, Drive Power, and Brake Load | Project (first-principles); ASME A17.1 governs the brake and its stopping distance | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `traction-roping-ratio` | Elevator Traction Roping Ratio, Torque, and Rope Tension | Project (first-principles); ASME A17.1 and the equipment manufacturer named | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `corrosion-rate-weight-loss` | Corrosion Rate from Coupon Weight Loss | Project (first-principles); ASTM G1 and the coupon's pit depth govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `galvanic-area-ratio` | Galvanic Corrosion and Area Ratio | Project (first-principles); the materials engineer governs | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `beer-color-srm` | Beer Color SRM from the Malt Bill | Project (first-principles); a spectrophotometer reading governs | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `brewhouse-efficiency` | Brewhouse Efficiency and Grain Bill | Project (first-principles); the malt analysis and measured gravities govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `carbonation-volumes-pressure` | Carbonation Volumes and Head Pressure | Project (first-principles); a dissolved-CO2 measurement governs | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `mash-strike-water` | Mash Strike Water Temperature and Thickness | Project (first-principles); the brewery's own measured mash temperatures govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
| `mash-tun-grain-bed` | Mash Tun Capacity and Grain Bed Depth | Project (first-principles); the lauter tun manufacturer's rated depth governs | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `proof-gallon-yield` | Distillation Charge, Cut, and Proof Gallon Yield | Project (first-principles); the TTB gauging tables govern | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `sparge-water-volume` | Sparge Water and Pre-Boil Volume | Project (first-principles); the brewery's own measured runoff governs | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
...
| `yeast-pitch-rate` | Yeast Pitch Rate and Cell Count | Project (first-principles); a viability count on the day governs | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
