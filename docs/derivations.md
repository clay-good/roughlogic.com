...
| `gobo-image-size` | Gobo Projected Image Size and Keystone | Project (first-principles); 2 x throw x tan(field/2); long axis throw sin(phi) [1/cos... | [test/fixtures/worked-examples.json](../test/fixtures/worked-examples.json) |
