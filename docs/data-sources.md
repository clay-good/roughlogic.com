...
- **Re-checked 2026-09-03 (6 of 47 rows):** LA, UT, IL and KY had transaction thresholds their legislatures repealed (2023 La. Acts 375 eff. 2023-08-01; Utah S.B. 47 eff. 2025-07-01; Ill. P.A. 104-0006 eff. 2026-01-01; 2026 Ky. Acts ch. 161 eff. 2026-08-01). NY and CT gained their conjunctive rule. The remaining 41 rows keep `verified_on: 2025-01-15` and the folder keeps warning, because re-stamping an unread row is the failure the freshness gates exist to prevent. The 17 rows that still carry a transaction prong are the highest-yield place to look next: the trend since 2023 is states repealing it.
