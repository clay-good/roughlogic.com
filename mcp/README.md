...
server that exposes the roughlogic catalog of **2,014 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,014 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,014 of 2,014 calculators name their
...
exist for 1,974 calculators. For the other 40 it projects the descriptors from
