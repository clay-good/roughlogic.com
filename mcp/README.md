...
server that exposes the roughlogic catalog of **2,072 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,072 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,072 of 2,072 calculators name their
...
exist for 2,032 calculators. For the other 40 it projects the descriptors from
