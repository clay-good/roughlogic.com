...
server that exposes the roughlogic catalog of **2,026 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,026 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,026 of 2,026 calculators name their
...
exist for 1,986 calculators. For the other 40 it projects the descriptors from
