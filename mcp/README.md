...
server that exposes the roughlogic catalog of **2,082 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,082 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,082 of 2,082 calculators name their
...
exist for 2,046 calculators. For the other 36 it projects the descriptors from
