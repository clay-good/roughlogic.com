...
server that exposes the roughlogic catalog of **2,076 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,076 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,076 of 2,076 calculators name their
...
exist for 2,036 calculators. For the other 40 it projects the descriptors from
