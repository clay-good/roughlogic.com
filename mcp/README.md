...
server that exposes the roughlogic catalog of **1,882 trades calculators**
...
clean through `run_calculator`. All three are checked for all 1,882 tiles on
every build.
...
`check-both-doors.mjs` holds that. **1,882 of 1,882 calculators name their
...
exist for 1,842 calculators. For the other 40 it projects the descriptors from
