...
server that exposes the roughlogic catalog of **2,052 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,052 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,052 of 2,052 calculators name their
...
exist for 2,012 calculators. For the other 40 it projects the descriptors from
