...
server that exposes the roughlogic catalog of **2,067 trades calculators**
...
clean through `run_calculator`. All three are checked for all 2,067 tiles on
every build.
...
`check-both-doors.mjs` holds that. **2,067 of 2,067 calculators name their
...
exist for 2,027 calculators. For the other 40 it projects the descriptors from
