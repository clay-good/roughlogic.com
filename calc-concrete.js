...
CONCRETE_RENDERERS["rc-beam-flexure"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fy", label: "Steel yield fy (psi)", kind: "number" },
...
CONCRETE_RENDERERS["rc-development-length"] = _simpleRenderer({
  ...
  fields: [
    { key: "fc", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "fy", label: "Bar yield fy (psi)", kind: "number" },
...
CONCRETE_RENDERERS["rc-column-axial"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "fy_psi", label: "Steel yield fy (psi)", kind: "number" },
    { key: "ast_in2", label: "Total longitudinal steel Ast (in²)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["rc-hook-development"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fy_psi", label: "Steel yield fy (psi)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "psi_e", label: "Epoxy factor psi_e", kind: "number" },
...
CONCRETE_RENDERERS["rc-doubly-reinforced"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "as_in2", label: "Tension steel As (in²)", kind: "number" },
    { key: "asp_in2", label: "Compression steel A's (in²)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "fy_psi", label: "Steel yield fy (psi)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["rc-shear-friction"] = _simpleRenderer({
  ...
  fields: [
    { key: "avf_in2", label: "Reinforcement crossing the plane Avf (in²)", kind: "number" },
    { key: "fy_psi", label: "Steel yield fy (psi)", kind: "number" },
    { key: "ac_in2", label: "Interface area Ac (in²)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
...
CONCRETE_RENDERERS["concrete-elastic-modulus"] = _simpleRenderer({
  ...
  fields: [
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "wc_pcf", label: "Unit weight wc (pcf, 145 normalweight)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-strength-from-modulus"] = _simpleRenderer({
  ...
  fields: [
    { key: "ec_psi", label: "Elastic modulus Ec (psi)", kind: "number" },
    { key: "wc_pcf", label: "Unit weight wc (pcf, 145 normalweight)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-modulus-of-rupture"] = _simpleRenderer({
  ...
  fields: [
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "lambda", label: "Lightweight factor lambda (1.0 NW, 0.75 LW)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-strength-from-rupture"] = _simpleRenderer({
  ...
  fields: [
    { key: "fr_psi", label: "Modulus of rupture fr (psi)", kind: "number" },
    { key: "lambda", label: "Lightweight factor lambda (1.0 NW, 0.75 LW)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-cracking-moment"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "h_in", label: "Section total depth h (in)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "lambda", label: "Lightweight factor lambda (1.0 NW, 0.75 LW)", kind: "number" },
  ],
  outputs: [
    ...
    { key: "sm", id: "ccm-out-sm", label: "Gross section modulus S = b h²/6", value: (r) => fmt(r.sm_in3, 0) + " in^3" },
...
CONCRETE_RENDERERS["concrete-depth-for-cracking-moment"] = _simpleRenderer({
  ...
  outputs: [
    ...
    { key: "sm", id: "cdcm-out-sm", label: "Gross section modulus S = b h²/6", value: (r) => fmt(r.sm_in3, 0) + " in^3" },
...
CONCRETE_RENDERERS["t-beam-effective-flange-width"] = _simpleRenderer({
  ...
  fields: [
    { key: "bw_in", label: "Web width bw (in)", kind: "number" },
    { key: "hf_in", label: "Flange (slab) thickness hf (in)", kind: "number" },
    { key: "ln_in", label: "Clear span ln (in)", kind: "number" },
    { key: "sw_in", label: "Clear distance to adjacent web sw (in)", kind: "number" },
...
CONCRETE_RENDERERS["concrete-torsion-threshold"] = _simpleRenderer({
  ...
  fields: [
    { key: "fc_psi", label: "Specified strength f'c (psi)", kind: "number" },
    { key: "b_in", label: "Section width b (in)", kind: "number" },
    { key: "h_in", label: "Section height h (in)", kind: "number" },
    { key: "lambda", label: "Lightweight factor lambda (1.0 normal)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-bearing-strength"] = _simpleRenderer({
  ...
  fields: [
    { key: "loaded_area_in2", label: "Loaded area A1 (in²)", kind: "number" },
    { key: "support_area_in2", label: "Supporting area A2 (in², >= A1)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
...
CONCRETE_RENDERERS["rc-compression-dev-length"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fy_psi", label: "Bar yield fy (psi)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "lambda", label: "Lightweight factor lambda (1.0 normalweight, 0.75 lightweight)", kind: "number" },
    { key: "psi_r", label: "Confinement factor psi_r (0.75 with ties/spiral, else 1.0)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-effective-inertia"] = _simpleRenderer({
  ...
  fields: [
    { key: "b_in", label: "Section width b (in)", kind: "number" },
    { key: "h_in", label: "Total depth h (in)", kind: "number" },
    { key: "d_in", label: "Effective depth d to tension steel (in)", kind: "number" },
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "ma_kipft", label: "Service moment Ma (kip-ft)", kind: "number" },
    { key: "lambda", label: "Lightweight factor lambda (1.0 NW, 0.75 LW)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-longterm-defl"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "duration_months", label: "Sustained-load duration (months, >=60 = 5 yr)", kind: "number" },
    { key: "comp_steel_ratio", label: "Compression-steel ratio rho' = As'/(b d) (0 if none)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-immediate-deflection"] = _simpleRenderer({
  ...
  fields: [
    { key: "ie_in4", label: "Effective inertia Ie (in⁴, from the Ie tile)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "w_klf", label: "Service load w (kip/ft)", kind: "number" },
    { key: "span_ft", label: "Span L (ft)", kind: "number" },
...
CONCRETE_RENDERERS["concrete-cracked-inertia-doubly"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
    { key: "asp_in2", label: "Compression steel area As' (in², 0 if none)", kind: "number" },
    { key: "dp_in", label: "Compression steel depth d' (in)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-cracked-inertia-tee"] = _simpleRenderer({
  ...
  fields: [
    { key: "b_in", label: "Effective flange width b (in)", kind: "number" },
    { key: "hf_in", label: "Flange thickness hf (in)", kind: "number" },
    { key: "bw_in", label: "Web width bw (in)", kind: "number" },
    { key: "d_in", label: "Effective depth d to tension steel (in)", kind: "number" },
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
...
CONCRETE_RENDERERS["concrete-corbel-bracket"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "fc_psi", label: "Concrete f'c (psi)", kind: "number" },
    { key: "fy_psi", label: "Steel fy (psi)", kind: "number" },
    { key: "friction_mu", label: "Shear-friction mu", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-anchor-pullout"] = _simpleRenderer({
  ...
  fields: [
    { key: "head_bearing_area_in2", label: "Head/nut net bearing area Abrg (in²)", kind: "number" },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number" },
...
CONCRETE_RENDERERS["concrete-anchor-blowout"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "perp_edge_in", label: "Perpendicular edge c_a2 (in, 0 = none)", kind: "number" },
...
CONCRETE_RENDERERS["curing-compound-coverage"] = _simpleRenderer({
  ...
  fields: [
    { key: "slab_area_sf", label: "Slab area (sf)", kind: "number" },
    { key: "coats", label: "Coats", kind: "number" },
    { key: "coverage_sf_per_gal", label: "Coverage (sf/gal, label governs)", kind: "number" },
    { key: "waste_pct", label: "Waste / overspray (%)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-isolation-joint"] = _simpleRenderer({
  ...
  fields: [
    { key: "slab_length_ft", label: "Slab length (ft)", kind: "number" },
    { key: "slab_width_ft", label: "Slab width (ft)", kind: "number" },
    { key: "num_columns", label: "Columns / piers in the slab", kind: "number" },
    { key: "column_perimeter_ft", label: "Perimeter per column (ft, 12 in sq = 4)", kind: "number" },
    { key: "strip_length_ft", label: "Filler strip length (ft)", kind: "number" },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-stair-volume"] = _simpleRenderer({
  ...
  fields: [
    { key: "num_risers", label: "Number of risers", kind: "number" },
    { key: "riser_in", label: "Riser height (in)", kind: "number" },
    { key: "tread_in", label: "Tread depth (in)", kind: "number" },
    { key: "width_in", label: "Stair width (in)", kind: "number" },
    { key: "throat_in", label: "Throat / waist thickness (in)", kind: "number" },
  ],
  outputs: [
...
// dims: in { joint_length_ft: L, slab_thickness_in: L, dowel_spacing_in: L, edge_clearance_in: L, num_joints: dimensionless } out: { dowels_per_joint: dimensionless, total_dowels: dimensionless, dowel_diameter_in: L }
...
CONCRETE_RENDERERS["concrete-premix-bags"] = _simpleRenderer({
  ...
  fields: [
    { key: "length_ft", label: "Length (ft)", kind: "number" },
