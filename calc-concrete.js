...
CONCRETE_RENDERERS["concrete-effective-inertia"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number", default: 3.0 },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number", default: 4000 },
...
CONCRETE_RENDERERS["concrete-immediate-deflection"] = _simpleRenderer({
  ...
  fields: [
    { key: "ie_in4", label: "Effective inertia Ie (in⁴, from the Ie tile)", kind: "number", default: 4662 },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number", default: 4000 },
...
CONCRETE_RENDERERS["concrete-cracked-inertia-doubly"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number", default: 3.0 },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number", default: 4000 },
    { key: "asp_in2", label: "Compression steel area As' (in², 0 if none)", kind: "number", default: 1.0 },
...
CONCRETE_RENDERERS["concrete-cracked-inertia-tee"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "bw_in", label: "Web width bw (in)", kind: "number", default: 12 },
    { key: "d_in", label: "Effective depth d to tension steel (in)", kind: "number", default: 17.5 },
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number", default: 6.0 },
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number", default: 4000 },
  ],
  outputs: [
...
CONCRETE_RENDERERS["concrete-premix-bags"] = _simpleRenderer({
  ...
  fields: [
    ...
    { key: "bag_yield_ft3", label: "Bag yield (ft³): 80lb 0.60, 60lb 0.45, 50lb 0.375, 40lb 0.30", kind: "number", default: 0.60 },
...
CONCRETE_RENDERERS["rc-tbeam-flexure"] = _simpleRenderer({
  ...
  fields: [
    { key: "fc_psi", label: "Concrete strength f'c (psi)", kind: "number", default: 4000 },
    { key: "fy_psi", label: "Steel yield fy (psi)", kind: "number", default: 60000 },
    { key: "as_in2", label: "Tension steel area As (in²)", kind: "number", default: 8 },
    { key: "bw_in", label: "Web width bw (in)", kind: "number", default: 12 },
